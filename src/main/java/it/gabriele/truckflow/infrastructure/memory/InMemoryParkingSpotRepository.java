...
public final class InMemoryParkingSpotRepository extends InMemoryRepository<ParkingSpot> implements ParkingSpotRepository {
    ...
    public Optional<ParkingSpot> findById(String id) {
        ...
        return findAll().stream()
                .filter(spot -> spot.getSpotNumber().equals(normalized))
                .findFirst();
    }
}

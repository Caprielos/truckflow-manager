...
public final class EmissionEstimate {
  ...
  public boolean isLowEmissionVehicle() {
    return emissionStandard.isLowEmissionStandard() || fuelType.isLowerEmissionAlternative();
  }

  public boolean isHighImpact() {
    return rating == EmissionRating.HIGH || rating == EmissionRating.VERY_HIGH;
  }
  ...
  public boolean isForShipment(String shipmentNumber) {
    return this.shipmentNumber.equals(
        validateCode(shipmentNumber, "Il numero spedizione da verificare è obbligatorio."));
  }

  public boolean isForRoute(String routeNumber) {
    return this.routeNumber.equals(
        validateCode(routeNumber, "Il numero tratta da verificare è obbligatorio."));
  }

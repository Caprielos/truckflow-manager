...
public final class DriverDefectTicket {
    ...
    private DriverDefectTicket(
        ...
        this.vehicleFleetNumber = normalizeCode(vehicleFleetNumber, "Il numero flotta mezzo è obbligatorio.");
    ...
    public static DriverDefectTicket of(
        ...
        return new DriverDefectTicket(ticketNumber, vehicleFleetNumber, driverCode, reportedAt, defectDescription, vehicleBlocked, notes);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(ticketNumber, vehicleFleetNumber, driverCode, reportedAt, defectDescription, vehicleBlocked, notes);
    }
}

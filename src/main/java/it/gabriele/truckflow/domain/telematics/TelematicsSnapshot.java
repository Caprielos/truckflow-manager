...
public final class TelematicsSnapshot {
    ...
    private TelematicsSnapshot(String vehicleFleetNumber, Instant recordedAt, double latitude, double longitude,
                               Long odometerKilometers, Double fuelLevelPercentage) {
    ...
    public static TelematicsSnapshot of(String vehicleFleetNumber, Instant recordedAt, double latitude, double longitude,
                                        Long odometerKilometers, Double fuelLevelPercentage) {
        return new TelematicsSnapshot(vehicleFleetNumber, recordedAt, latitude, longitude, odometerKilometers, fuelLevelPercentage);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(vehicleFleetNumber, recordedAt, latitude, longitude, odometerKilometers, fuelLevelPercentage);
    }
}

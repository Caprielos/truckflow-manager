...
public final class CustomerContractRules {
    ...
    public static boolean canPriceShipmentOn(CustomerContract contract, LocalDate date) {
        ...
        return contract.isValidOn(date)
                && contract.hasTariff(TariffRuleType.BASE_TRANSPORT_FEE);
    }
    ...
    public static boolean requiresManualPricingForTemperatureControlledTransport(CustomerContract contract) {
        validateContract(contract);

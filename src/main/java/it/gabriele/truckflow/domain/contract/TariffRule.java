...
/**
 * Riga di listino contrattuale: può essere un importo fisso, una tariffa per unità o una percentuale.
 */
public final class TariffRule {
    ...
    public static TariffRule percentage(
        ...
        return new TariffRule(ruleCode, type, description, ChargeUnit.PERCENTAGE_OF_BASE_FEE, null, percentage, mandatory, notes);
    }
    ...
    private void validatePricingMode() {
        if (unit.isPercentageBased()) {
            ...
            if (amount != null) {
                throw new IllegalArgumentException("Una tariffa percentuale non deve avere un importo fisso.");
            }
            return;
        }
    ...
    private static String validateDescription(String description) {
        ...
        if (normalized.length() > MAX_DESCRIPTION_LENGTH) {
            throw new IllegalArgumentException("La descrizione regola tariffaria non può superare " + MAX_DESCRIPTION_LENGTH + " caratteri.");
        }
        return normalized;
    }

    public String getRuleCode() { return ruleCode; }
    public TariffRuleType getType() { return type; }
    public String getDescription() { return description; }
    public ChargeUnit getUnit() { return unit; }
    public Money getAmount() { return amount; }
    public Percentage getPercentage() { return percentage; }

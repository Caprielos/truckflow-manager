...
public final class ContractRateCard {
    ...
    public static ContractRateCard of(String rateCardCode, String name, List<TariffRule> rules, Notes notes) {
    ...
    private static String validateCode(String code) {
        ...
        if (normalized.length() > MAX_CODE_LENGTH) {
            throw new IllegalArgumentException("Il codice listino non può superare " + MAX_CODE_LENGTH + " caratteri.");
        }
        if (!normalized.matches("[A-Z0-9_-]+")) {
            throw new IllegalArgumentException("Il codice listino può contenere solo lettere, numeri, trattini e underscore.");
        }
        return normalized;
    }
    ...
    private static String validateName(String name) {
        ...
        if (normalized.length() > MAX_NAME_LENGTH) {
            throw new IllegalArgumentException("Il nome listino non può superare " + MAX_NAME_LENGTH + " caratteri.");
        }
        return normalized;
    }
    ...
    public List<TariffRule> getRules() { return rules; }

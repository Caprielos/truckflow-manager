...
public final class DeliveryNoteLine {
    ...
    public static DeliveryNoteLine of(
        ...
        return new DeliveryNoteLine(lineCode, description, packagesCount, grossWeightKilograms, volumeCubicMeters, palletCount, notes);
    }
    ...
    private static String validateCode(String code) {
        ...
        if (normalized.length() > MAX_CODE_LENGTH) {
            throw new IllegalArgumentException("Il codice riga bolla non può superare " + MAX_CODE_LENGTH + " caratteri.");
        }
        if (!normalized.matches("[A-Z0-9_-]+")) {
            throw new IllegalArgumentException("Il codice riga bolla può contenere solo lettere, numeri, trattini e underscore.");
        }
        return normalized;
    }
    ...
    private static String validateDescription(String description) {
        ...
        if (normalized.length() > MAX_DESCRIPTION_LENGTH) {
            throw new IllegalArgumentException("La descrizione riga bolla non può superare " + MAX_DESCRIPTION_LENGTH + " caratteri.");
        }
        return normalized;
    }
    ...
    public double getGrossWeightKilograms() { return grossWeightKilograms; }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(lineCode, description, packagesCount, grossWeightKilograms, volumeCubicMeters, palletCount, notes);
    }
}

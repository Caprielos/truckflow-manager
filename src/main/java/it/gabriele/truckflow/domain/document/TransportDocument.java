...
public final class TransportDocument {
  ...
  private TransportDocument(
    ...
    this.referenceNumber =
        validateCode(referenceNumber, "Il riferimento documento è obbligatorio.");
    ...
    if (expirationDate != null && expirationDate.isBefore(issueDate)) {
      throw new IllegalArgumentException(
          "La scadenza documento non può essere precedente alla data documento.");
    }
  ...
  public static TransportDocument draft(
    ...
    return new TransportDocument(
        documentNumber, type, referenceNumber, issueDate, null, DocumentStatus.DRAFT, notes);
  }
  ...
  public String formatSingleLine() {
    return documentNumber + " - " + referenceNumber + " - " + type + " - " + status;
  }
  ...
  public int hashCode() {
    return Objects.hash(
        documentNumber, type, referenceNumber, issueDate, expirationDate, status, notes);
  }

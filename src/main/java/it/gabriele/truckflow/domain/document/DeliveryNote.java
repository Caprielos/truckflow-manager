...
public final class DeliveryNote {
    ...
    private DeliveryNote(
        ...
        this.shipmentNumber = validateCode(shipmentNumber, "Il numero spedizione bolla è obbligatorio.");
        ...
        this.loadingLocationCode = validateCode(loadingLocationCode, "Il luogo carico bolla è obbligatorio.");
        this.unloadingLocationCode = validateCode(unloadingLocationCode, "Il luogo scarico bolla è obbligatorio.");
        if (issueDate == null) {
    ...
    public static DeliveryNote of(
        ...
        return new DeliveryNote(documentNumber, shipmentNumber, senderCode, receiverCode, loadingLocationCode,
                unloadingLocationCode, issueDate, lines, requiredTemperatureRange, notes);
    }
    ...
    private static String validateCode(String code, String message) {
        ...
        if (normalized.length() > MAX_CODE_LENGTH) {
            throw new IllegalArgumentException("Il codice bolla non può superare " + MAX_CODE_LENGTH + " caratteri.");
        }
        if (!normalized.matches("[A-Z0-9_-]+")) {
            throw new IllegalArgumentException("Il codice bolla può contenere solo lettere, numeri, trattini e underscore.");
        }
        return normalized;
    }
    ...
    public String getLoadingLocationCode() { return loadingLocationCode; }
    public String getUnloadingLocationCode() { return unloadingLocationCode; }
    public LocalDate getIssueDate() { return issueDate; }
    public List<DeliveryNoteLine> getLines() { return lines; }
    public Optional<TemperatureRange> getRequiredTemperatureRange() { return Optional.ofNullable(requiredTemperatureRange); }

...
public final class ImportRecord {
  ...
  public static ImportRecord of(
    ...
    return new ImportRecord(
        recordCode, sourceType, externalRowId, status, referenceNumber, amount, occurredAt, notes);
  }
  ...
  private static String validateCode(String code, String message) {
    ...
    if (normalized.length() > MAX_CODE_LENGTH) {
      throw new IllegalArgumentException(
          "Il codice import non può superare " + MAX_CODE_LENGTH + " caratteri.");
    }
  ...
  public String getExternalRowId() {
    return externalRowId;
  }

  public ImportRecordStatus getStatus() {
    return status;
  }

...
public final class TrackingEvent {
    ...
    public String formatSingleLine() {
        return eventCode + " - " + missionNumber + " - " + shipmentNumber + " - " + type + " - " + occurredAt;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(eventCode, missionNumber, shipmentNumber, type, occurredAt, coordinates, notes);
    }

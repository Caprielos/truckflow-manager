...
public final class TrackingRules {
  ...
  public static boolean canAddEvent(TrackingTimeline timeline, TrackingEvent newEvent) {
  ...
  public static boolean isPickupAndDeliveryCompleted(TrackingTimeline timeline) {
    ...
    return timeline.hasPickupCompleted() && timeline.hasDeliveryCompleted();
  }
  ...
  public static boolean hasExceptionEvents(TrackingTimeline timeline) {
    ...
    return timeline.getEvents().stream().anyMatch(TrackingEvent::isExceptionEvent);
  }

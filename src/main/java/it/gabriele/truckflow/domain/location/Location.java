...
/**
 * Rappresenta un luogo fisico del dominio.
 * Esempio: magazzino, cliente, deposito, punto di ritiro o punto di consegna.
 */
public final class Location {
    ...
    private static String validateName(String name) {
        ...
        if (normalizedName.length() > MAX_NAME_LENGTH) {
            throw new IllegalArgumentException("Il nome del luogo non può superare " + MAX_NAME_LENGTH + " caratteri.");
        }

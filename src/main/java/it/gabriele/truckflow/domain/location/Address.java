...
/** Rappresenta un indirizzo fisico. Serve per clienti, magazzini, ritiri e consegne. */
public final class Address {
  ...
  private static String validateRequiredText(String value, String fieldName) {
    ...
    if (normalizedValue.length() > MAX_FIELD_LENGTH) {
      throw new IllegalArgumentException(
          fieldName + " non può superare " + MAX_FIELD_LENGTH + " caratteri.");
    }
  ...
  private static String validateCountryCode(String countryCode) {
    String normalizedCountryCode =
        validateRequiredText(countryCode, "Il codice paese").toUpperCase();

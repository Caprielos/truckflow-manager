...
/**
 * Rappresenta un intervallo di temperatura espresso in gradi Celsius. Serve per merce refrigerata e
...
public final class TemperatureRange {
  ...
  /**
   * Verifica se questo intervallo è coperto da un altro intervallo. Esempio: 2-8°C è coperto da
   * 0-10°C.
   */

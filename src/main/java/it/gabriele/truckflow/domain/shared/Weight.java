...
/** Rappresenta un peso del dominio. Internamente il peso viene sempre salvato in chilogrammi. */
public final class Weight {
  ...
  /** Crea un peso partendo dalle tonnellate, convertendole subito in chilogrammi. */

 ...
 * Internamente lunghezza, larghezza e altezza vengono sempre salvate in metri.
 */
public final class Dimension {
    ...
    /**
     * Crea una dimensione partendo da valori espressi in centimetri,
     * convertendoli subito in metri.
     */
    public static Dimension ofCentimeters(double lengthCentimeters, double widthCentimeters, double heightCentimeters) {

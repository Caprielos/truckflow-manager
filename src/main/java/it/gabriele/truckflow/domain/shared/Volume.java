...
/**
 * Rappresenta un volume del dominio.
 * Internamente il volume viene sempre salvato in metri cubi.
 */
public final class Volume {
    ...
    /**
     * Crea un volume partendo dai litri,
     * convertendoli subito in metri cubi.
     */

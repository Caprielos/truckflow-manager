...
/**
 * Contiene regole di compliance complessive. Collega autista, mezzo, carico, allestimento, tratta e
 * spedizione.
 */
public final class ComplianceRules {
  ...
  public static boolean isVehicleCompliantForShipment(
    ...
    return VehicleCombinationRules.canBeAssignedToShipment(vehicleCombination, shipment)
        && VehicleBodyCompatibilityRules.isBodyCompatibleWithCargoLoad(
            vehicleCombination, shipment.getCargoLoad());
  }
  ...
  public static boolean isRouteCompliantForShipment(RoutePlan routePlan, Shipment shipment) {

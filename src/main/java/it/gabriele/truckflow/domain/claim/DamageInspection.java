...
public final class DamageInspection {
    ...
    private DamageInspection(
        ...
        this.inspectionNumber = normalize(inspectionNumber, "Il numero controllo danni è obbligatorio.");
        this.vehicleFleetNumber = normalize(vehicleFleetNumber, "Il numero flotta mezzo è obbligatorio.");
    ...
    public static DamageInspection of(
        ...
        return new DamageInspection(inspectionNumber, vehicleFleetNumber, driverCode, performedAt, items, notes);
    }

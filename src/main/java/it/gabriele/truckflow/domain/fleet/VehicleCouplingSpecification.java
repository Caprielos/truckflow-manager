...
public final class VehicleCouplingSpecification {
  ...
  public static VehicleCouplingSpecification fifthWheel(
      Double heightMeters, KingpinDiameter kingpinDiameter) {
    return new VehicleCouplingSpecification(
        CouplingType.FIFTH_WHEEL, heightMeters, kingpinDiameter, null, null);
  }

  public static VehicleCouplingSpecification drawbar(
      Double drawbarLengthMeters, String drawbarEyeType) {
    return new VehicleCouplingSpecification(
        CouplingType.DRAWBAR_EYE, null, null, drawbarLengthMeters, drawbarEyeType);
  }
  ...
  public int hashCode() {
    return Objects.hash(
        couplingType, fifthWheelHeightMeters, kingpinDiameter, drawbarLengthMeters, drawbarEyeType);
  }
}

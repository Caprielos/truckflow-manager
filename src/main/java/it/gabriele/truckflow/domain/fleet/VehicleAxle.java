...
public final class VehicleAxle {
    ...
    private VehicleAxle(int axleNumber, WheelConfiguration wheelConfiguration, boolean liftable, AxleSteeringType steeringType) {
        if (axleNumber < 1) {
    ...
    public static VehicleAxle of(int axleNumber, WheelConfiguration wheelConfiguration, boolean liftable, AxleSteeringType steeringType) {

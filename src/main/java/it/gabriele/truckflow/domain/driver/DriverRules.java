...
public final class DriverRules {
  ...
  public static boolean hasRequiredLicenseForVehicleCombination(
      Driver driver, VehicleCombination vehicleCombination) {
    validateDriver(driver);
  ...
  public static boolean hasRequiredAdrCertificatesForCargoLoad(Driver driver, CargoLoad cargoLoad) {
    validateDriver(driver);
  ...
  public static boolean hasValidAdrCertificatesForCargoLoad(
      Driver driver, CargoLoad cargoLoad, LocalDate date) {
    validateDriver(driver);
    validateCargoLoad(cargoLoad);
    if (date == null) {
      throw new IllegalArgumentException("La data verifica certificati è obbligatoria.");
  ...
  public static boolean hasValidOperationalCertificatesForShipment(
      Driver driver, Shipment shipment, LocalDate date) {
    validateDriver(driver);
    validateShipment(shipment);
    if (date == null) {
      throw new IllegalArgumentException("La data verifica certificati è obbligatoria.");
    ...
    if (shipment.requiresTemperatureControlledTransport()
        && !driver.hasValidCertificate(
            DriverCertificateType.TEMPERATURE_CONTROLLED_TRANSPORT, date)) {
      return false;
    }
    if (shipment.isInternational()
  ...
  public static boolean canDriveVehicleCombinationOnDate(
      Driver driver, VehicleCombination vehicleCombination, LocalDate date) {
    validateDriver(driver);
    validateVehicleCombination(vehicleCombination);
    if (date == null) {
      throw new IllegalArgumentException("La data verifica certificati è obbligatoria.");
  ...
  public static boolean canBeAssignedToShipment(
      Driver driver, VehicleCombination vehicleCombination, Shipment shipment) {
    validateDriver(driver);
    validateVehicleCombination(vehicleCombination);
    validateShipment(shipment);
  ...
  public static boolean canBeAssignedToShipmentOnDate(
      Driver driver, VehicleCombination vehicleCombination, Shipment shipment, LocalDate date) {
    validateDriver(driver);
    validateVehicleCombination(vehicleCombination);
    validateShipment(shipment);
    if (date == null) {

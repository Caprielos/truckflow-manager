...
/**
 * Certificato reale dell'autista, con scadenza.
 * Le enum già presenti restano utili per compatibilità e regole semplici,
 * questa enum serve per l'anagrafica professionale completa.
 */

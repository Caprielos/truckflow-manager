...
public final class CargoItem {
    ...
    private CargoItem(
        ...
        if (category.requiresTemperatureControl() && requiredTemperatureRange == null) {
            throw new IllegalArgumentException("Questa categoria di carico richiede una temperatura controllata.");
        }
    ...
    public boolean isDangerousGoods() {
        return category == CargoCategory.HAZARDOUS_MATERIAL
                || dangerousGoodsProfile != null;
    }
    ...
    public boolean requiresAdrTankTransport() {
        return dangerousGoodsProfile != null
                && dangerousGoodsProfile.requiresTankTransport();
    }
    ...
    public boolean isAdrClass(AdrClass adrClass) {
        ...
        return dangerousGoodsProfile != null
                && dangerousGoodsProfile.getAdrClass() == adrClass;
    }
    ...
    public String formatSingleLine() {
        ...
        return description + " - " + category + " - " + weight + " - " + dangerousGoodsProfile.getUnNumber();
    }

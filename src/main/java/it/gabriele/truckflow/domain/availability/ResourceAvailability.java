...
public final class ResourceAvailability {
  ...
  public static ResourceAvailability of(
    ...
    return new ResourceAvailability(
        resourceType, resourceCode, dateRange, timeWindow, status, notes);
  }
  ...
  public static ResourceAvailability available(
      ...
      Notes notes) {
    return of(
        resourceType, resourceCode, dateRange, timeWindow, AvailabilityStatus.AVAILABLE, notes);
  }
  ...
  public static ResourceAvailability reserved(
      ...
      Notes notes) {
    return of(
        resourceType, resourceCode, dateRange, timeWindow, AvailabilityStatus.RESERVED, notes);
  }
  ...
  public static ResourceAvailability assigned(
      ...
      Notes notes) {
    return of(
        resourceType, resourceCode, dateRange, timeWindow, AvailabilityStatus.ASSIGNED, notes);
  }
  ...
  public static ResourceAvailability unavailable(
      ...
      Notes notes) {
    return of(
        resourceType, resourceCode, dateRange, timeWindow, AvailabilityStatus.UNAVAILABLE, notes);
  }
  ...
  public static ResourceAvailability maintenance(
      ...
      Notes notes) {
    return of(
        resourceType, resourceCode, dateRange, timeWindow, AvailabilityStatus.MAINTENANCE, notes);
  }
  ...
  public static ResourceAvailability onLeave(
      ...
      Notes notes) {
    return of(
        resourceType, resourceCode, dateRange, timeWindow, AvailabilityStatus.ON_LEAVE, notes);
  }
  ...
  private static String validateResourceCode(String resourceCode) {
    ...
    if (normalizedResourceCode.length() > MAX_RESOURCE_CODE_LENGTH) {
      throw new IllegalArgumentException(
          "Il codice risorsa non può superare " + MAX_RESOURCE_CODE_LENGTH + " caratteri.");
    }

    if (!normalizedResourceCode.matches("[A-Z0-9_-]+")) {
      throw new IllegalArgumentException(
          "Il codice risorsa può contenere solo lettere, numeri, trattini e underscore.");
    }
  ...
  public boolean isSameResource(ResourceAvailability other) {
    ...
    return resourceType == other.resourceType && resourceCode.equals(other.resourceCode);
  }

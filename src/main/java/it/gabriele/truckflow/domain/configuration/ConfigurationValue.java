...
public final class ConfigurationValue {
  ...
  private ConfigurationValue(ConfigurationValueType type, String rawValue) {
    if (type == null) {
  ...
  public static ConfigurationValue ofDurationMinutes(int minutes) {
    return new ConfigurationValue(
        ConfigurationValueType.DURATION_MINUTES, Integer.toString(minutes));
  }

  private static String validateRawValue(ConfigurationValueType type, String rawValue) {
  ...
  private static String validateText(String value) {
    if (value.length() > MAX_TEXT_LENGTH) {
      throw new IllegalArgumentException(
          "Il valore testuale configurazione non può superare " + MAX_TEXT_LENGTH + " caratteri.");
    }
  ...
  private static String validateBoolean(String value) {
    ...
    if (!normalized.equals("true") && !normalized.equals("false")) {
      throw new IllegalArgumentException(
          "Il valore booleano configurazione deve essere true o false.");
    }
  ...
  private static String validateInteger(String value) {
    try {
      ...
      throw new IllegalArgumentException(
          "Il valore intero configurazione non è valido.", exception);
    }
  }
  ...
  private static String validateDecimal(String value) {
    try {
      ...
      throw new IllegalArgumentException(
          "Il valore decimale configurazione non è valido.", exception);
    }
  }
  ...
  private static String validatePercentage(String value) {
    ...
    try {
      ...
      throw new IllegalArgumentException(
          "Il valore percentuale configurazione non è valido.", exception);
    }

    if (percentage.compareTo(BigDecimal.ZERO) < 0
        || percentage.compareTo(BigDecimal.valueOf(100)) > 0) {
      throw new IllegalArgumentException(
          "Il valore percentuale configurazione deve essere tra 0 e 100.");
    }
  ...
  private static String validateDurationMinutes(String value) {
    ...
    try {
      ...
      throw new IllegalArgumentException(
          "La durata in minuti configurazione non è valida.", exception);
    }

    if (minutes < 0) {
      throw new IllegalArgumentException(
          "La durata in minuti configurazione non può essere negativa.");
    }
  ...
  private void ensureType(ConfigurationValueType expectedType) {
    if (type != expectedType) {
      throw new IllegalStateException(
          "Il valore configurazione non è di tipo " + expectedType + ".");
    }
  }

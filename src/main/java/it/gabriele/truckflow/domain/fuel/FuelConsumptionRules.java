...
public final class FuelConsumptionRules {
  ...
  public static double calculateKilometersPerLiter(
      FuelTransaction previous, FuelTransaction current) {
  ...
  public static boolean isConsumptionAnomaly(
    ...
    if (expectedKilometersPerLiter <= 0
        || Double.isNaN(expectedKilometersPerLiter)
        || Double.isInfinite(expectedKilometersPerLiter)) {

...
public final class FuelTransaction {
    ...
    private FuelTransaction(String vehicleFleetNumber, LocalDateTime occurredAt, double liters, Money pricePerLiter,
                            long odometerKilometers, FuelCardProvider cardProvider) {
    ...
    public static FuelTransaction of(String vehicleFleetNumber, LocalDateTime occurredAt, double liters, Money pricePerLiter,
                                     long odometerKilometers, FuelCardProvider cardProvider) {
        return new FuelTransaction(vehicleFleetNumber, occurredAt, liters, pricePerLiter, odometerKilometers, cardProvider);
    }
    ...
    public double calculateKilometersPerLiter(FuelTransaction previousTransaction) {
        ...
        if (kilometers < 0) {
            throw new IllegalArgumentException("I chilometri attuali non possono essere inferiori al rifornimento precedente.");
        }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(vehicleFleetNumber, occurredAt, liters, pricePerLiter, odometerKilometers, cardProvider);
    }
}

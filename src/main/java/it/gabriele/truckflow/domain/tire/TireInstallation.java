...
public final class TireInstallation {
    ...
    private TireInstallation(
        ...
        if (removedAt != null && removedAtKilometers < installedAtKilometers) {
            throw new IllegalArgumentException("I km rimozione non possono essere inferiori ai km installazione.");
        }
        this.tire = tire;
    ...
    public static TireInstallation active(
        ...
        return new TireInstallation(tire, vehicleFleetNumber, wheelPosition, installedAt, installedAtKilometers, null, 0);
    }

    public TireInstallation remove(LocalDate removedAt, long removedAtKilometers) {
        return new TireInstallation(tire, vehicleFleetNumber, wheelPosition, installedAt, installedAtKilometers, removedAt, removedAtKilometers);
    }
    ...
    public long calculateKilometersMounted(long currentVehicleKilometers) {
        if (currentVehicleKilometers < installedAtKilometers) {
            throw new IllegalArgumentException("I km attuali non possono essere inferiori ai km installazione.");
        }
        if (removedAt != null) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(tire, vehicleFleetNumber, wheelPosition, installedAt, installedAtKilometers, removedAt, removedAtKilometers);
    }
}

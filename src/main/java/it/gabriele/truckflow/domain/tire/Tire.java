...
public final class Tire {
  ...
  private Tire(
    ...
    if (treadDepthMillimeters < 0
        || Double.isNaN(treadDepthMillimeters)
        || Double.isInfinite(treadDepthMillimeters)) {
    ...
    if (currentKilometers < installedAtKilometers) {
      throw new IllegalArgumentException(
          "I km attuali non possono essere inferiori ai km di installazione.");
    }
  ...
  public static Tire of(
      ...
      long currentKilometers) {
    return new Tire(
        tireCode, status, treadDepthMillimeters, installedAtKilometers, currentKilometers);
  }

...
public final class TireRules {
  ...
  public static boolean shouldScheduleReplacement(
      Tire tire, double companyWarningDepthMillimeters) {
    validate(tire);
    if (companyWarningDepthMillimeters < LEGAL_MINIMUM_TREAD_DEPTH_MM) {
      throw new IllegalArgumentException(
          "La soglia aziendale non può essere sotto il minimo legale.");
    }

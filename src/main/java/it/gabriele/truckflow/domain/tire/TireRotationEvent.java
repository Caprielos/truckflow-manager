...
public final class TireRotationEvent {
    ...
    private TireRotationEvent(
        ...
        if (fromPosition.equals(toPosition)) {
            throw new IllegalArgumentException("La posizione di partenza e arrivo devono essere diverse.");
        }
        if (occurredAt == null) {
    ...
    public static TireRotationEvent of(
        ...
        return new TireRotationEvent(tireCode, vehicleFleetNumber, fromPosition, toPosition, occurredAt, odometerKilometers, notes);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(tireCode, vehicleFleetNumber, fromPosition, toPosition, occurredAt, odometerKilometers, notes);
    }
}

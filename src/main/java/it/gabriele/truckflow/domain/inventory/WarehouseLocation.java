...
public final class WarehouseLocation {
  ...
  private WarehouseLocation(
      String facilityCode, String zoneCode, String shelfCode, String binCode) {
  ...
  public static WarehouseLocation of(
      String facilityCode, String zoneCode, String shelfCode, String binCode) {
  ...
  private static String validateCode(String code, String message) {
    ...
    if (normalized.length() > MAX_CODE_LENGTH) {
      throw new IllegalArgumentException(
          "Il codice posizione non può superare " + MAX_CODE_LENGTH + " caratteri.");
    }
    if (!normalized.matches("[A-Z0-9_-]+")) {
      throw new IllegalArgumentException(
          "Il codice posizione può contenere solo lettere, numeri, trattini e underscore.");
    }
    return normalized;
  }

...
public final class PaymentRecord {
    ...
    private PaymentRecord(
        ...
        this.invoiceNumber = validateCode(invoiceNumber, "Il numero fattura del pagamento è obbligatorio.");
    ...
    public boolean isForInvoiceNumber(String invoiceNumber) {
        return this.invoiceNumber.equals(validateCode(invoiceNumber, "Il numero fattura da verificare è obbligatorio."));
    }

...
public final class BillingRules {
  ...
  public static boolean isPaymentMatchingInvoice(PaymentRecord paymentRecord, Invoice invoice) {
  ...
  public static boolean canRegisterPayment(PaymentRecord paymentRecord, Invoice invoice) {
    validatePaymentRecord(paymentRecord);
    validateInvoice(invoice);

    return canBeMarkedPaid(invoice) && isPaymentMatchingInvoice(paymentRecord, invoice);
  }

  public static boolean paymentsCoverInvoice(List<PaymentRecord> paymentRecords, Invoice invoice) {
    validatePaymentRecords(paymentRecords);
    validateInvoice(invoice);

    List<PaymentRecord> matchingPayments =

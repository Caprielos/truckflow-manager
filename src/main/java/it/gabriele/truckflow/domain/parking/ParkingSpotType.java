...
public enum ParkingSpotType {
  ...
  public boolean canHost(ParkingResourceType resourceType) {
    ...
    return switch (this) {
      ...
      case RIGID_TRUCK_SPACE ->
          resourceType == ParkingResourceType.RIGID_TRUCK
              || resourceType == ParkingResourceType.VAN;
      case TRACTOR_UNIT_SPACE -> resourceType == ParkingResourceType.TRACTOR_UNIT;
      case TRAILER_SPACE ->
          resourceType == ParkingResourceType.TRAILER
              || resourceType == ParkingResourceType.SEMI_TRAILER;
      case SEMI_TRAILER_SPACE -> resourceType == ParkingResourceType.SEMI_TRAILER;
      case FULL_COMBINATION_SPACE ->
          resourceType == ParkingResourceType.ARTICULATED_VEHICLE
              || resourceType == ParkingResourceType.TRUCK_AND_TRAILER;
      case LONG_COMBINATION_SPACE -> resourceType.isCombination();
      case EQUIPMENT_SPACE ->
          resourceType == ParkingResourceType.EQUIPMENT
              || resourceType == ParkingResourceType.OTHER;

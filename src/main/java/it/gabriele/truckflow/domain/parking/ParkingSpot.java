...
public final class ParkingSpot {
    ...
    private ParkingSpot(
        ...
        this.facilityCode = validateCode(facilityCode, "Il codice struttura del posto parcheggio è obbligatorio.");
        this.spotNumber = validateCode(spotNumber, "Il numero posto parcheggio è obbligatorio.");
        this.type = validateType(type);
        this.status = validateStatus(status);
        this.maxLengthMeters = validatePositiveMeasure(maxLengthMeters, "La lunghezza massima posto parcheggio deve essere positiva.");
        this.maxWidthMeters = validatePositiveMeasure(maxWidthMeters, "La larghezza massima posto parcheggio deve essere positiva.");
    ...
    public static ParkingSpot of(
        ...
        return new ParkingSpot(facilityCode, spotNumber, type, status, maxLengthMeters, maxWidthMeters, powerSupplyAvailable, notes);
    }
    ...
    public static ParkingSpot available(
        ...
        return new ParkingSpot(facilityCode, spotNumber, type, ParkingSpotStatus.AVAILABLE,
                maxLengthMeters, maxWidthMeters, powerSupplyAvailable, notes);
    }
    ...
    public static ParkingSpot occupied(
        ...
        return new ParkingSpot(facilityCode, spotNumber, type, ParkingSpotStatus.OCCUPIED,
                maxLengthMeters, maxWidthMeters, powerSupplyAvailable, notes);
    }
    ...
    public boolean isSamePhysicalSpot(String facilityCode, String spotNumber) {
        return this.facilityCode.equals(validateCode(facilityCode, "Il codice struttura da confrontare è obbligatorio."))
                && this.spotNumber.equals(validateCode(spotNumber, "Il numero posto da confrontare è obbligatorio."));
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(facilityCode, spotNumber, type, status, maxLengthMeters, maxWidthMeters, powerSupplyAvailable, notes);
    }

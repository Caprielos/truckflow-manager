...
/**
 * Singola componente di costo di un acquisto flotta: mezzo, rimorchio, allestimento, gomme,
 * telematica, pratiche.
 */
public final class FleetAssetCostComponent {
  ...
  private FleetAssetCostComponent(
      ...
      Notes notes) {
    this.componentCode =
        validateCode(componentCode, "Il codice componente acquisto è obbligatorio.");
    if (type == null) {
  ...
  public static FleetAssetCostComponent of(
      ...
      String assignedVehicleFleetNumber,
      Notes notes) {
    return new FleetAssetCostComponent(
        componentCode, type, description, price, assignedVehicleFleetNumber, notes);
  }
  ...
  public static FleetAssetCostComponent taxableNet(
    ...
    return of(
        ...
        type,
        description,
        VatBreakdown.taxableFromNet(netAmount, vatRate),
  ...
  private static String validateDescription(String description) {
    ...
    if (normalized.isEmpty()) {
      throw new IllegalArgumentException(
          "La descrizione componente acquisto non può essere vuota.");
    }
    if (normalized.length() > MAX_DESCRIPTION_LENGTH) {
      throw new IllegalArgumentException(
          "La descrizione componente acquisto non può superare "

...
/**
 * Riga ricavo cliente con IVA. Il ricavo vero è l'imponibile; l'IVA incassata è debito verso l'erario.
 */
public final class TaxableRevenueLine {
    ...
    private TaxableRevenueLine(String lineCode, MissionRevenueType type, String description, VatBreakdown price, Notes notes) {
    ...
    public static TaxableRevenueLine of(String lineCode, MissionRevenueType type, String description, VatBreakdown price, Notes notes) {
    ...
    public static TaxableRevenueLine baseTransportFee(String lineCode, String description, Money netAmount, VatRate vatRate, Notes notes) {
        return taxableNet(lineCode, MissionRevenueType.BASE_TRANSPORT_FEE, description, netAmount, vatRate, notes);
    }
    ...
    private static String validateDescription(String description) {
        ...
        if (normalized.isEmpty()) {
            throw new IllegalArgumentException("La descrizione riga ricavo imponibile non può essere vuota.");
        }
        if (normalized.length() > MAX_DESCRIPTION_LENGTH) {
            throw new IllegalArgumentException("La descrizione riga ricavo imponibile non può superare "

...
public final class EconomicsRules {
  ...
  public static boolean missionMeetsMinimumMargin(
      MissionEconomics economics, Percentage minimumMargin) {
    validateMission(economics);
  ...
  public static boolean shouldReviewMissionBeforeAcceptance(
      MissionEconomics economics, Percentage minimumMargin) {
    validateMission(economics);
    if (minimumMargin == null) {
      throw new IllegalArgumentException("Il margine minimo è obbligatorio.");

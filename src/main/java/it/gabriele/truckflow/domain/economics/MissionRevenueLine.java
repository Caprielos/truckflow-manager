...
public final class MissionRevenueLine {
    ...
    private MissionRevenueLine(String lineCode, MissionRevenueType type, String description, Money amount, Notes notes) {
    ...
    public static MissionRevenueLine of(String lineCode, MissionRevenueType type, String description, Money amount, Notes notes) {
        return new MissionRevenueLine(lineCode, type, description, amount, notes);
    }

    public static MissionRevenueLine baseTransportFee(String lineCode, String description, Money amount, Notes notes) {
        return of(lineCode, MissionRevenueType.BASE_TRANSPORT_FEE, description, amount, notes);
    }

    public static MissionRevenueLine fromPricingLine(String lineCode, MissionRevenueType type, PricingLine pricingLine, Notes notes) {
        if (pricingLine == null) {
    ...
    private static String validateDescription(String description) {
        ...
        if (normalized.length() > MAX_DESCRIPTION_LENGTH) {
            throw new IllegalArgumentException("La descrizione ricavo missione non può superare "

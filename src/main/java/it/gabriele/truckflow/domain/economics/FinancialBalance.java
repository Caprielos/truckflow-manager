...
/**
 * Rappresenta un saldo economico che può essere positivo, zero o negativo. Money nel dominio non
 * può essere negativo, quindi per utile/perdita/debito serve un value object dedicato.
 */

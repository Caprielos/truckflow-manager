...
/**
 * Fattura cliente economica con imponibile, IVA e totale lordo. Serve a non confondere IVA
 * incassata con guadagno dell'azienda.
 */
public final class CustomerRevenueInvoice {
  ...
  private CustomerRevenueInvoice(
    ...
    if (dueDate.isBefore(issueDate)) {
      throw new IllegalArgumentException(
          "La scadenza fattura cliente non può precedere l'emissione.");
    }
  ...
  public static CustomerRevenueInvoice of(
      ...
      List<TaxableRevenueLine> lines,
      Notes notes) {
    return new CustomerRevenueInvoice(
        invoiceNumber, customerCode, shipmentNumber, issueDate, dueDate, lines, notes);
  }
  ...
  public static CustomerRevenueInvoice of(
    ...
    return of(
        invoiceNumber, customerCode, shipmentNumber, issueDate, dueDate, lines, Notes.empty());
  }

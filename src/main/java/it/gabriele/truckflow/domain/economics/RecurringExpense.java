...
public final class RecurringExpense {
  ...
  public static RecurringExpense of(
    ...
    return new RecurringExpense(
        expenseCode, category, description, period, amount, assignedVehicleFleetNumber, notes);
  }
  ...
  public static RecurringExpense noVat(
    ...
    return of(
        ...
        description,
        period,
        VatBreakdown.outOfScope(amount, "NO_VAT"),
  ...
  private static String validateDescription(String description) {
    ...
    if (normalized.length() > MAX_DESCRIPTION_LENGTH) {
      throw new IllegalArgumentException(
          "La descrizione spesa ricorrente non può superare "

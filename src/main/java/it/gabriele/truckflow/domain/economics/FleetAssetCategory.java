...
public enum FleetAssetCategory {
    ...
    public boolean isEquipment() {
        return switch (this) {
            case BODY_EQUIPMENT, CURTAINSIDER_BODY, BOX_BODY, REFRIGERATED_BODY, TIPPER_BODY,
                 TANK_BODY, REFRIGERATION_UNIT, LOADING_EQUIPMENT, TAIL_LIFT, CRANE, FORKLIFT,
                 PALLET_JACK, TELEMATICS_DEVICE, GPS_TRACKER, TACHOGRAPH, DASHCAM,
                 WORKSHOP_EQUIPMENT, WAREHOUSE_EQUIPMENT, SOFTWARE_LICENSE -> true;
            default -> false;
        };
    }

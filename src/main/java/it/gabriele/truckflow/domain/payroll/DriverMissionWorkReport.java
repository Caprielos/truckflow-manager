...
/**
 * Riepilogo lavorativo della missione: ore guida/lavoro, indennità, merce, convoglio, allestimento
 * e qualifiche realmente impiegate. È la base per calcolare il costo autista.
 */
public final class DriverMissionWorkReport {
  ...
  private DriverMissionWorkReport(Builder builder) {
    this.reportCode =
        validateCode(builder.reportCode, "Il codice report lavoro autista è obbligatorio.");
    ...
    this.otherWorkTime =
        validateDuration(builder.otherWorkTime, "Le ore altro lavoro sono obbligatorie.");
    this.waitingTime = validateDuration(builder.waitingTime, "Le ore attesa sono obbligatorie.");
    this.loadingUnloadingTime =
        validateDuration(builder.loadingUnloadingTime, "Le ore carico/scarico sono obbligatorie.");
    this.overtime = validateDuration(builder.overtime, "Le ore straordinario sono obbligatorie.");
    this.nightWorkTime =
        validateDuration(builder.nightWorkTime, "Le ore notturne sono obbligatorie.");
    this.sundayWorkTime =
        validateDuration(builder.sundayWorkTime, "Le ore domenicali sono obbligatorie.");
    this.holidayWorkTime =
        validateDuration(builder.holidayWorkTime, "Le ore festive sono obbligatorie.");
    this.domesticAllowanceDays =
        validateNonNegative(
            builder.domesticAllowanceDays,
            "I giorni diaria nazionale non possono essere negativi.");
    this.internationalAllowanceDays =
        validateNonNegative(
            builder.internationalAllowanceDays,
            "I giorni diaria estera non possono essere negativi.");
    this.overnightDays =
        validateNonNegative(builder.overnightDays, "I pernottamenti non possono essere negativi.");
    this.cargoCategories =
        validateSet(builder.cargoCategories, "Le categorie merce non possono contenere null.");
    ...
    this.loadingEquipmentTypes =
        validateSet(
            builder.loadingEquipmentTypes, "Le attrezzature di carico non possono contenere null.");
  ...
  public boolean usesTipperBody() {
    return bodyBaseType == VehicleBodyBaseType.REAR_TIPPER
        || bodyBaseType == VehicleBodyBaseType.THREE_WAY_TIPPER;
  }
  ...
  private static Duration validateDuration(Duration duration, String nullMessage) {
    ...
    if (duration.isNegative()) {
      throw new IllegalArgumentException(
          "Le durate del report lavoro non possono essere negative.");
    }
    return duration;
  }
  ...
  public static final class Builder {
    ...
    public Builder vehicleContext(
        VehicleCombinationType combinationType, VehicleBodyBaseType bodyBaseType) {

...
/**
 * Tipi di voce economica che possono comporre il costo reale di un autista. Il modello è
 * volutamente esteso: nella realtà una missione può pagare base, ore, indennità, rischi,
 * qualifiche, rimorchi/allestimenti e maggiorazioni operative.
 */
public enum DriverPayComponentType {
  ...
  public boolean isEmployerCost() {
    return switch (this) {
      case SOCIAL_CONTRIBUTIONS, EMPLOYER_INSURANCE, TRAINING_AMORTIZATION, HEALTH_SURVEILLANCE ->
          true;
      default -> false;
    };
  }

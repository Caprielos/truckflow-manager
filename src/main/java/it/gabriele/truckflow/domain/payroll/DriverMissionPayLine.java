...
public final class DriverMissionPayLine {
    ...
    public static DriverMissionPayLine of(
        ...
        return new DriverMissionPayLine(lineCode, componentType, unit, description, quantity, amount, notes);
    }
    ...
    private static String validateCode(String code) {
        ...
        if (normalized.length() > MAX_CODE_LENGTH) {
            throw new IllegalArgumentException("Il codice riga paga non può superare " + MAX_CODE_LENGTH + " caratteri.");
        }
        if (!normalized.matches("[A-Z0-9_-]+")) {
            throw new IllegalArgumentException("Il codice riga paga può contenere solo lettere, numeri, trattini e underscore.");
        }
        return normalized;
    }
    ...
    private static String validateDescription(String description) {
        ...
        if (normalized.length() > MAX_DESCRIPTION_LENGTH) {
            throw new IllegalArgumentException("La descrizione riga paga non può superare " + MAX_DESCRIPTION_LENGTH + " caratteri.");
        }
        return normalized;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(lineCode, componentType, unit, description, normalizedQuantity(), amount, notes);
    }
}

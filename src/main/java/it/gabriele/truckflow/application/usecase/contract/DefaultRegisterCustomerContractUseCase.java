...
import it.gabriele.truckflow.application.port.out.contract.CustomerContractRepository;
import it.gabriele.truckflow.domain.contract.CustomerContract;
import java.util.Objects;

/** Caso d'uso: registrare un contratto/listino cliente. */
public final class DefaultRegisterCustomerContractUseCase
    implements RegisterCustomerContractUseCase {
  ...
  public DefaultRegisterCustomerContractUseCase(CustomerContractRepository repository) {
    this.repository =
        Objects.requireNonNull(repository, "Il repository contratti cliente è obbligatorio.");
  }

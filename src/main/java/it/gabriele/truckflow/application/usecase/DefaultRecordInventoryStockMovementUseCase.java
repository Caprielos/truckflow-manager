 ...
 */
public final class DefaultRecordInventoryStockMovementUseCase implements RecordInventoryStockMovementUseCase {
    ...
    public DefaultRecordInventoryStockMovementUseCase(
        ...
        this.itemRepository = Objects.requireNonNull(itemRepository, "Il repository articoli è obbligatorio.");
        this.warehouseLocationRepository = Objects.requireNonNull(warehouseLocationRepository, "Il repository posizioni magazzino è obbligatorio.");
        this.movementRepository = Objects.requireNonNull(movementRepository, "Il repository movimenti magazzino è obbligatorio.");
        this.balanceRepository = Objects.requireNonNull(balanceRepository, "Il repository saldi magazzino è obbligatorio.");
    }
    ...
    public InventoryBalance handle(Command command) {
        ...
        WarehouseLocation location = warehouseLocationRepository.getRequired(command.locationId(), "Posizione magazzino");

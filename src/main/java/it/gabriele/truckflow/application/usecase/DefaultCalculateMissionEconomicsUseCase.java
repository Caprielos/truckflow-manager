 ...
 */
public final class DefaultCalculateMissionEconomicsUseCase implements CalculateMissionEconomicsUseCase {
    ...
    public DefaultCalculateMissionEconomicsUseCase(
        ...
        this.economicsRepository = Objects.requireNonNull(economicsRepository, "Il repository economics missione è obbligatorio.");
    }

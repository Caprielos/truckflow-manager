...
public final class DefaultAssignParkingSpotUseCase implements AssignParkingSpotUseCase {
    ...
    public DefaultAssignParkingSpotUseCase(
        ...
        this.parkingSpotRepository = Objects.requireNonNull(parkingSpotRepository, "Il repository posti parcheggio è obbligatorio.");
        this.parkingAssignmentRepository = Objects.requireNonNull(parkingAssignmentRepository, "Il repository assegnazioni parcheggio è obbligatorio.");
    }
    ...
    public ParkingAssignment handle(Command command) {
        ...
        ParkingSpot spot = parkingSpotRepository.getRequired(command.parkingSpotId(), "Posto parcheggio");

 ...
 */
public final class DefaultCalculateDriverMissionPayrollUseCase implements CalculateDriverMissionPayrollUseCase {
    ...
    public DefaultCalculateDriverMissionPayrollUseCase(
        ...
        this.workReportRepository = Objects.requireNonNull(workReportRepository, "Il repository report lavoro autista è obbligatorio.");
        this.payrollPolicyRepository = Objects.requireNonNull(payrollPolicyRepository, "Il repository policy paga è obbligatorio.");
        this.payrollRepository = Objects.requireNonNull(payrollRepository, "Il repository payroll è obbligatorio.");
    }
    ...
    public DriverMissionPayroll handle(Command command) {
        ...
        DriverMissionWorkReport report = workReportRepository.getRequired(command.workReportId(), "Report lavoro autista");
        DriverPayrollPolicy policy = payrollPolicyRepository.getRequired(command.payrollPolicyId(), "Politica paga autista");
        DriverMissionPayroll payroll = DriverPayrollRules.calculateMissionPayroll(
                command.payrollCode(),
                report,
                policy,
                command.notes()

 ...
 */
public final class DefaultCreateShipmentFromAcceptedOrderUseCase implements CreateShipmentFromAcceptedOrderUseCase {
    ...
    public DefaultCreateShipmentFromAcceptedOrderUseCase(
        ...
        this.orderRepository = Objects.requireNonNull(orderRepository, "Il repository ordini è obbligatorio.");
    ...
    public Shipment handle(Command command) {
        ...
        TransportOrder order = orderRepository.getRequired(command.orderNumber(), "Ordine di trasporto");
        Shipment shipment = Shipment.fromAcceptedOrder(command.shipmentNumber(), order, command.notes());

...
public final class DefaultGenerateShipmentDocumentBundleUseCase
    implements GenerateShipmentDocumentBundleUseCase {
  ...
  public DefaultGenerateShipmentDocumentBundleUseCase(
      ShipmentRepository shipmentRepository, ShipmentDocumentBundleRepository bundleRepository) {
    this.shipmentRepository =
        Objects.requireNonNull(shipmentRepository, "Il repository spedizioni è obbligatorio.");
    this.bundleRepository =
        Objects.requireNonNull(
            bundleRepository, "Il repository fascicoli documentali è obbligatorio.");
  }

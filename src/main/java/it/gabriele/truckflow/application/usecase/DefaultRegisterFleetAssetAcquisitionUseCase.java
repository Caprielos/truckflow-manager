 ...
 */
public final class DefaultRegisterFleetAssetAcquisitionUseCase implements RegisterFleetAssetAcquisitionUseCase {
    ...
    public DefaultRegisterFleetAssetAcquisitionUseCase(FleetAssetAcquisitionRepository repository) {
        this.repository = Objects.requireNonNull(repository, "Il repository acquisizioni flotta è obbligatorio.");
    }

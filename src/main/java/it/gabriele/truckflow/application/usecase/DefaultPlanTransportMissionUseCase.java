...
public final class DefaultPlanTransportMissionUseCase implements PlanTransportMissionUseCase {
    ...
    public DefaultPlanTransportMissionUseCase(
        ...
        this.driverRepository = Objects.requireNonNull(driverRepository, "Il repository autisti è obbligatorio.");
        this.vehicleCombinationRepository = Objects.requireNonNull(vehicleCombinationRepository, "Il repository convogli è obbligatorio.");
        this.routePlanRepository = Objects.requireNonNull(routePlanRepository, "Il repository route plan è obbligatorio.");
        this.missionRepository = Objects.requireNonNull(missionRepository, "Il repository missioni è obbligatorio.");
    }
    ...
    public TransportMission handle(Command command) {
        ...
        VehicleCombination combination = vehicleCombinationRepository.getRequired(command.vehicleCombinationId(), "Convoglio");

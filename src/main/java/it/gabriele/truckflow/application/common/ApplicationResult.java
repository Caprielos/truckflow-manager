...
/**
 * Risultato applicativo generico. Serve quando un adapter web/CLI vuole evitare eccezioni.
 * I casi d'uso possono comunque lanciare eccezioni di dominio per input impossibili.
 */

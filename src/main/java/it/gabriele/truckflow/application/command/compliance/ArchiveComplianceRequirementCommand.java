...
/** Command used to archive a compliance requirement catalog entry. */
public record ArchiveComplianceRequirementCommand(ComplianceRequirementId requirementId)
    implements ApplicationCommand {

  public ArchiveComplianceRequirementCommand {

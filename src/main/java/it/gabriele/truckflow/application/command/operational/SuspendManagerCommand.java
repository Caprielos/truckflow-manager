...
/** Command used to suspend an operational manager role. */
public record SuspendManagerCommand(ManagerId id, String updatedBy) implements ApplicationCommand {

  public SuspendManagerCommand {

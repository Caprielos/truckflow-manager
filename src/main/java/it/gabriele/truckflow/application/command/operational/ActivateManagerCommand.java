...
/** Command used to activate an operational manager role. */
public record ActivateManagerCommand(ManagerId id, String updatedBy) implements ApplicationCommand {

  public ActivateManagerCommand {

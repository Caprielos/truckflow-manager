...
/** Command used to activate a compliance requirement catalog entry. */
public record ActivateComplianceRequirementCommand(ComplianceRequirementId requirementId)
    implements ApplicationCommand {

  public ActivateComplianceRequirementCommand {

...
class AssignParkingSpotUseCaseTest {
  ...
  void shouldAssignReadyArticulatedVehicleToCombinationParkingSpot() {
    ...
    ParkedResource resource =
        ParkedResource.articulatedVehicle(
            "COMBO-001", "TRAC-001", "SEMI-001", "Trattore + semirimorchio frigo", 16.5, true);
  ...
  private static final class InMemoryParkingAssignmentRepository

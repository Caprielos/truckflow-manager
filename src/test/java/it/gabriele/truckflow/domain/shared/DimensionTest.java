...
class DimensionTest {
    ...
    void shouldNotAllowInvalidNumbers() {
        ...
        assertThrows(IllegalArgumentException.class, () -> Dimension.ofMeters(Double.POSITIVE_INFINITY, 1, 1));
        assertThrows(IllegalArgumentException.class, () -> Dimension.ofMeters(1, Double.POSITIVE_INFINITY, 1));
        assertThrows(IllegalArgumentException.class, () -> Dimension.ofMeters(1, 1, Double.POSITIVE_INFINITY));
    }

...
class DateRangeTest {
  ...
  void shouldCreateDateRangeUsingLocalDate() {
    DateRange range = DateRange.of(LocalDate.of(2026, 1, 1), LocalDate.of(2026, 12, 31));
  ...
  void shouldNotAllowNullStartOrEndDate() {
    assertThrows(
        IllegalArgumentException.class, () -> DateRange.of(null, LocalDate.of(2026, 12, 31)));

    assertThrows(
        IllegalArgumentException.class, () -> DateRange.of(LocalDate.of(2026, 1, 1), null));
  }

  @Test
  void shouldNotAllowStartDateAfterEndDate() {
    assertThrows(IllegalArgumentException.class, () -> DateRange.of("2026-12-31", "2026-01-01"));
  }
  ...
  void shouldConsiderEquivalentDateRangesEqual() {
    ...
    DateRange second = DateRange.of(LocalDate.of(2026, 1, 1), LocalDate.of(2026, 12, 31));

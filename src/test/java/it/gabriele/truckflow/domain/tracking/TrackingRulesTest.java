...
class TrackingRulesTest {
    ...
    void shouldRejectDuplicatedEventCode() {
        ...
        TrackingEvent duplicated = event(
                "TRK-001",
                TrackingEventType.ARRIVED,
                "2026-07-01T12:00:00Z"
        );
    ...
    void shouldRequireOperationalReviewWhenDelayOrIncidentExists() {
        TrackingTimeline normalTimeline = TrackingTimeline.of(
                event("TRK-001", TrackingEventType.DEPARTED, "2026-07-01T08:00:00Z")
        );

        TrackingTimeline delayTimeline = TrackingTimeline.of(
                event("TRK-001", TrackingEventType.DEPARTED, "2026-07-01T08:00:00Z"),
    ...
    void shouldNotAllowNullValues() {
        ...
        assertThrows(IllegalArgumentException.class, () -> TrackingRules.canAddEvent(null, event("TRK-002", TrackingEventType.ARRIVED, "2026-07-01T12:00:00Z")));
        assertThrows(IllegalArgumentException.class, () -> TrackingRules.canAddEvent(timeline, null));
        assertThrows(IllegalArgumentException.class, () -> TrackingRules.requiresOperationalReview(null));
        assertThrows(IllegalArgumentException.class, () -> TrackingRules.isPickupAndDeliveryCompleted(null));
        assertThrows(IllegalArgumentException.class, () -> TrackingRules.isMissionTrackingCompleted(null));

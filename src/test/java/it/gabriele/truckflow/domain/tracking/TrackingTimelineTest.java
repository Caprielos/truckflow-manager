...
class TrackingTimelineTest {
  ...
  void shouldNotAllowEmptyNullOrNullItems() {
    assertThrows(
        IllegalArgumentException.class, () -> TrackingTimeline.of((List<TrackingEvent>) null));
    assertThrows(IllegalArgumentException.class, () -> TrackingTimeline.of(List.of()));

    List<TrackingEvent> eventsWithNull =
        Arrays.asList(event("TRK-001", TrackingEventType.DEPARTED, "2026-07-01T08:00:00Z"), null);
  ...
  void shouldRejectEventsFromDifferentMissionOrShipment() {
    ...
    TrackingEvent differentMission =
        TrackingEvent.of(
            "TRK-002",
            "MIS-002",
            "SHP-001",
    ...
    TrackingEvent differentShipment =
        TrackingEvent.of(
            "TRK-003",
            "MIS-001",
            "SHP-002",
    ...
    assertThrows(
        IllegalArgumentException.class, () -> TrackingTimeline.of(first, differentMission));
    assertThrows(
        IllegalArgumentException.class, () -> TrackingTimeline.of(first, differentShipment));
  }

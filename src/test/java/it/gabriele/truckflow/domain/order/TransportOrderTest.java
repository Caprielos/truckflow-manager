...
class TransportOrderTest {
    ...
    void shouldCreateSubmittedTransportOrder() {
        TransportOrder order = TransportOrder.submitted(
                "ORD-001",
    ...
    void shouldNormalizeOrderNumber() {
        TransportOrder order = TransportOrder.draft(
                "  ord_001  ",
                activeCustomerAccount(),
                standardCargoLoad(),
                pickupFacility(),
    ...
    void shouldNotAllowInvalidOrderNumber() {
        assertThrows(IllegalArgumentException.class, () -> TransportOrder.draft(
                null,
                activeCustomerAccount(),
                standardCargoLoad(),
                pickupFacility(),
    ...
    void shouldAcceptSubmittedOrder() {
        TransportOrder accepted = standardDraftOrder()
                .submit()
                .accept();
    ...
    void shouldRejectSubmittedOrder() {
        TransportOrder rejected = standardDraftOrder()
                .submit()
                .reject();

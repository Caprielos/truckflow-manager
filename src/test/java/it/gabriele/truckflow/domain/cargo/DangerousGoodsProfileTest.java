...
class DangerousGoodsProfileTest {
  ...
  void shouldCreateDangerousGoodsProfileForGasWithoutPackingGroup() {
    DangerousGoodsProfile profile =
        DangerousGoodsProfile.of(
            "UN 1965",
  ...
  void shouldNotAllowInvalidHazardLabels() {
    ...
    Set<HazardLabel> labelsWithNull =
        new HashSet<>(Arrays.asList(HazardLabel.LABEL_3_FLAMMABLE_LIQUID, null));
  ...
  void shouldExposeAdrCertificateRequirements() {
    ...
    DangerousGoodsProfile packagedProfile =
        DangerousGoodsProfile.of(
            "UN 1202",
            "Diesel fuel",
            AdrClass.CLASS_3_FLAMMABLE_LIQUIDS,

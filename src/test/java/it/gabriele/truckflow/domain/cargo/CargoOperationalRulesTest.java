...
class CargoOperationalRulesTest {
  ...
  void shouldRequireAdrDocumentsAndVehicleApprovalForDangerousGoods() {
    ...
    assertTrue(
        CargoOperationalRules.requiredDocumentsFor(CargoCategory.DANGEROUS_GOODS)
            .contains(TransportDocumentType.SAFETY_DATA_SHEET));
    assertTrue(
        CargoOperationalRules.requiredVehicleCertificatesFor(CargoCategory.DANGEROUS_GOODS)
  ...
  void shouldRequireFirAndEerForWaste() {
    ...
    assertTrue(
        CargoOperationalRules.requiredDocumentsFor(CargoCategory.WASTE_DANGEROUS)
  ...
  void shouldRequireAtpForTemperatureControlledGoods() {
    assertTrue(
        CargoOperationalRules.requiredVehicleCertificatesFor(CargoCategory.REFRIGERATED_FOOD)

...
class VehicleCombinationTest {
  ...
  void shouldCreateSingleVehicleCombination() {
    ...
    VehicleCombination combination =
        VehicleCombination.singleVehicle("combo-001", truck, Notes.empty());
  ...
  void shouldCreateVehicleCombinationWithTrailer() {
    ...
    VehicleCombination combination =
        VehicleCombination.withTrailer("combo-001", tractor, trailer, Notes.empty());
  ...
  void shouldNormalizeCombinationNumber() {
    VehicleCombination combination =
        VehicleCombination.singleVehicle("  combo_001  ", rigidTruck(), Notes.empty());
  ...
  void shouldNotAllowInvalidCombinationNumber() {
    assertThrows(
        ...
        () -> VehicleCombination.singleVehicle(null, rigidTruck(), Notes.empty()));

    assertThrows(
        IllegalArgumentException.class,
        () -> VehicleCombination.singleVehicle("COMBO 001", rigidTruck(), Notes.empty()));
  }
  ...
  void shouldNotAllowTooLongCombinationNumber() {
    ...
    assertThrows(
        IllegalArgumentException.class,
        () ->
            VehicleCombination.singleVehicle(
                tooLongCombinationNumber, rigidTruck(), Notes.empty()));
  }
  ...
  void shouldNotAllowNullPoweredUnitOrNotes() {
    assertThrows(
        IllegalArgumentException.class,
        () -> VehicleCombination.singleVehicle("COMBO-001", null, Notes.empty()));

    assertThrows(
        IllegalArgumentException.class,
        () -> VehicleCombination.singleVehicle("COMBO-001", rigidTruck(), null));
  }
  ...
  void shouldNotAllowTrailerAsPoweredUnit() {
    assertThrows(
        IllegalArgumentException.class,
        () -> VehicleCombination.singleVehicle("COMBO-001", semiTrailer(), Notes.empty()));
  }
  ...
  void shouldNotAllowSingleNonCargoVehicle() {
    assertThrows(
        IllegalArgumentException.class,
        () -> VehicleCombination.singleVehicle("COMBO-001", tractorUnit(), Notes.empty()));
  }
  ...
  void shouldRequireTrailerInTrailerFactory() {
    assertThrows(
        IllegalArgumentException.class,
        () -> VehicleCombination.withTrailer("COMBO-001", tractorUnit(), null, Notes.empty()));
  }
  ...
  void shouldNotAllowNonTrailerAsTrailer() {
    assertThrows(
        IllegalArgumentException.class,
        () ->
            VehicleCombination.withTrailer(
                "COMBO-001", tractorUnit(), rigidTruck(), Notes.empty()));
  }
  ...
  void shouldExposeCargoCapacityFromTrailer() {
    VehicleCombination combination =
        VehicleCombination.withTrailer("COMBO-001", tractorUnit(), semiTrailer(), Notes.empty());
  ...
  void shouldCheckIfCombinationCanBeAssigned() {
    VehicleCombination availableCombination =
        VehicleCombination.withTrailer("COMBO-001", tractorUnit(), semiTrailer(), Notes.empty());

    VehicleCombination unavailableCombination =
        VehicleCombination.withTrailer(
            "COMBO-002", assignedTractorUnit(), semiTrailer(), Notes.empty());
  ...
  void shouldCheckTemperatureCapacity() {
    VehicleCombination combination =
        VehicleCombination.withTrailer(
            "COMBO-001", tractorUnit(), refrigeratedTrailer(), Notes.empty());
  ...
  void shouldNotCheckNullCapacityValues() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> combination.canSupportTemperatureRange(null));
  }
  ...
  void shouldDetectNotes() {
    VehicleCombination combination =
        VehicleCombination.singleVehicle(
            "COMBO-001", rigidTruck(), Notes.of("Combinazione preferita per tratte urbane"));
  ...
  void shouldConsiderEquivalentCombinationsEqual() {
    VehicleCombination first =
        VehicleCombination.withTrailer("COMBO-001", tractorUnit(), semiTrailer(), Notes.empty());

    VehicleCombination second =
        VehicleCombination.withTrailer("COMBO-001", tractorUnit(), semiTrailer(), Notes.empty());

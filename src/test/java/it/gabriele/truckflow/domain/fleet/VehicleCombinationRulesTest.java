...
class VehicleCombinationRulesTest {
  ...
  void shouldCheckEnoughWeightCapacity() {
    ...
    assertTrue(VehicleCombinationRules.hasEnoughWeightCapacity(combination, standardCargoLoad()));

    assertFalse(VehicleCombinationRules.hasEnoughWeightCapacity(combination, tooHeavyCargoLoad()));
  }
  ...
  void shouldCheckEnoughVolumeCapacity() {
    ...
    assertTrue(VehicleCombinationRules.hasEnoughVolumeCapacity(combination, standardCargoLoad()));

    assertFalse(
        VehicleCombinationRules.hasEnoughVolumeCapacity(combination, tooLargeVolumeCargoLoad()));
  }
  ...
  void shouldCheckEnoughSpaceForEveryItem() {
    ...
    assertTrue(
        VehicleCombinationRules.hasEnoughSpaceForEveryItem(combination, standardCargoLoad()));

    assertFalse(
        VehicleCombinationRules.hasEnoughSpaceForEveryItem(combination, itemTooLongCargoLoad()));
  }
  ...
  void shouldSupportStandardCargoTemperatureRequirement() {
    ...
    assertTrue(
        VehicleCombinationRules.supportsRequiredTemperature(combination, standardCargoLoad()));
  }
  ...
  void shouldDetectMissingTemperatureSupport() {
    ...
    assertFalse(
        VehicleCombinationRules.supportsRequiredTemperature(
            standardCombination, refrigeratedCargoLoad()));
  }
  ...
  void shouldDetectTemperatureSupport() {
    ...
    assertTrue(
        VehicleCombinationRules.supportsRequiredTemperature(
            refrigeratedCombination, refrigeratedCargoLoad()));
  }
  ...
  void shouldCheckIfCombinationCanPhysicallyCarryCargoLoad() {
    ...
    assertTrue(VehicleCombinationRules.canPhysicallyCarry(combination, standardCargoLoad()));

    assertFalse(VehicleCombinationRules.canPhysicallyCarry(combination, tooHeavyCargoLoad()));

    assertFalse(VehicleCombinationRules.canPhysicallyCarry(combination, itemTooLongCargoLoad()));
  }
  ...
  void shouldCheckIfCombinationCanBeAssignedToCargoLoad() {
    ...
    assertTrue(
        VehicleCombinationRules.canBeAssignedToCargoLoad(
            availableCombination, standardCargoLoad()));

    assertFalse(
        VehicleCombinationRules.canBeAssignedToCargoLoad(
            unavailableCombination, standardCargoLoad()));
  }
  ...
  void shouldCheckIfCombinationCanBeAssignedToShipment() {
    ...
    assertTrue(VehicleCombinationRules.canBeAssignedToShipment(combination, shipment));
  }
  ...
  void shouldNotAssignIncompatibleCombinationToRefrigeratedShipment() {
    ...
    assertFalse(
        VehicleCombinationRules.canBeAssignedToShipment(standardCombination, refrigeratedShipment));
  }
  ...
  void shouldAssignRefrigeratedCombinationToRefrigeratedShipment() {
    ...
    assertTrue(
        VehicleCombinationRules.canBeAssignedToShipment(
            refrigeratedCombination, refrigeratedShipment));
  }
  ...
  private static VehicleCombination standardCombination() {
    return VehicleCombination.withTrailer("COMBO-001", tractorUnit(), semiTrailer(), Notes.empty());
  }

  private static VehicleCombination refrigeratedCombination() {
    return VehicleCombination.withTrailer(
        "COMBO-002", tractorUnit(), refrigeratedTrailer(), Notes.empty());
  }

  private static VehicleCombination unavailableCombination() {
    return VehicleCombination.withTrailer(
        "COMBO-003", assignedTractorUnit(), semiTrailer(), Notes.empty());
  }

...
class SustainabilityRulesTest {
  ...
  void shouldCompareEmissionStandards() {
    assertTrue(
        SustainabilityRules.hasBetterEmissionStandard(lowEmissionEstimate(), standardEstimate()));

    assertFalse(
        SustainabilityRules.hasBetterEmissionStandard(standardEstimate(), lowEmissionEstimate()));
  }

  @Test
  void shouldCalculateTotalCo2() {
    double total =
        SustainabilityRules.calculateTotalCo2Kg(
            List.of(standardEstimate(), lowEmissionEstimate(), highImpactEstimate()));
  ...
  void shouldCheckListRules() {
    assertTrue(
        SustainabilityRules.containsHighImpactEstimate(
            List.of(standardEstimate(), highImpactEstimate())));

    assertTrue(SustainabilityRules.allEstimatesAreLowEmission(List.of(lowEmissionEstimate())));

    assertFalse(SustainabilityRules.allEstimatesAreLowEmission(List.of()));
    assertFalse(
        SustainabilityRules.allEstimatesAreLowEmission(
            List.of(standardEstimate(), lowEmissionEstimate())));
  }
  ...
  void shouldNotAllowNullValues() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> SustainabilityRules.isLowEmissionTransport(null));
    assertThrows(
        IllegalArgumentException.class, () -> SustainabilityRules.isHighImpactTransport(null));
    assertThrows(
        IllegalArgumentException.class,
        () -> SustainabilityRules.requiresSustainabilityReview(null));
    assertThrows(
        IllegalArgumentException.class, () -> SustainabilityRules.isZeroTailpipeEmission(null));
    assertThrows(
        IllegalArgumentException.class,
        () -> SustainabilityRules.hasBetterEmissionStandard(null, estimate));
    assertThrows(
        IllegalArgumentException.class,
        () -> SustainabilityRules.hasBetterEmissionStandard(estimate, null));
    assertThrows(
        IllegalArgumentException.class, () -> SustainabilityRules.calculateTotalCo2Kg(null));
    assertThrows(
        IllegalArgumentException.class, () -> SustainabilityRules.containsHighImpactEstimate(null));
    assertThrows(
        IllegalArgumentException.class, () -> SustainabilityRules.allEstimatesAreLowEmission(null));
  }
  ...
  void shouldNotAllowNullItemsInsideList() {
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> SustainabilityRules.calculateTotalCo2Kg(estimatesWithNull));
    assertThrows(
        IllegalArgumentException.class,
        () -> SustainabilityRules.containsHighImpactEstimate(estimatesWithNull));
    assertThrows(
        IllegalArgumentException.class,
        () -> SustainabilityRules.allEstimatesAreLowEmission(estimatesWithNull));
  }

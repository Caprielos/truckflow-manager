...
class IdentityRulesTest {
    ...
    void shouldNotAllowNullValues() {
        ...
        assertThrows(IllegalArgumentException.class, () -> IdentityRules.canPerformSensitiveAction(null, UserPermission.MANAGE_USERS));
        assertThrows(IllegalArgumentException.class, () -> IdentityRules.canPerformSensitiveAction(account, null));
        assertThrows(IllegalArgumentException.class, () -> IdentityRules.requiresStrongAuthentication(null));
    }
    ...
    private static UserAccount dispatcherAccount() {
        return UserAccount.active(
                ...
                Set.of(
                        UserPermission.VIEW_SHIPMENTS,
                        UserPermission.MANAGE_OPERATIONS
                ),
                Notes.empty()
        );
    }

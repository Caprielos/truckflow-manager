...
class ComplianceRulesTest {
    ...
    void shouldApproveCompliantStandardAssignment() {
        assertTrue(ComplianceRules.isAssignmentCompliant(
                standardDriver(),
    ...
    void shouldRejectVehicleWithoutEnoughBodyCompatibility() {
        assertFalse(ComplianceRules.isVehicleCompliantForShipment(
                flatbedCombination(),
                fragileShipment()
        ));
    }
    ...
    void shouldRejectAdrTankShipmentWithDriverWithoutAdrTank() {
        assertFalse(ComplianceRules.isDriverCompliantForShipment(
    ...
    void shouldRejectRouteWithoutMatchingPickupFacility() {
        RoutePlan wrongRoute = RoutePlan.of(
                "RTE-WRONG",
                List.of(
                        RouteStop.of(1, RouteStopType.START, wrongPickupFacility(), TimeWindow.of("07:00", "08:00"), Notes.empty()),
                        RouteStop.of(2, RouteStopType.PICKUP, wrongPickupFacility(), TimeWindow.of("08:00", "09:00"), Notes.empty()),
        ...
        assertFalse(ComplianceRules.isRouteCompliantForShipment(
                wrongRoute,
                standardShipment()
        ));
    }
    ...
    void shouldRejectRouteWithoutMatchingDeliveryFacility() {
        RoutePlan wrongRoute = RoutePlan.of(
                ...
                List.of(
                        ...
                        RouteStop.of(3, RouteStopType.DELIVERY, wrongDeliveryFacility(), TimeWindow.of("14:00", "15:00"), Notes.empty()),
                        RouteStop.of(4, RouteStopType.END, wrongDeliveryFacility(), TimeWindow.of("16:00", "17:00"), Notes.empty())
                ),
                Distance.ofKilometers(580),
                Notes.empty()
        );
    ...
    private static Vehicle trailer(String fleetNumber, String chassisNumber, VehicleBodyType bodyType) {
    ...
    private static Facility wrongPickupFacility() {
        return Facility.active(
                ...
                Location.of(
                        "Magazzino Torino",
                        Address.of("Via Po 5", "Torino", "10100", "IT"),
                        "Europe/Rome"
                ),
                TimeWindow.of("08:00", "18:00"),
                Notes.empty()

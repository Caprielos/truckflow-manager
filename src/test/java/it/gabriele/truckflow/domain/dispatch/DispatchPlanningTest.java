...
class DispatchPlanningTest {
    ...
    void shouldChooseReadyParkedCombinationWithBestMargin() {
        DispatchAssignmentCandidate ready = DispatchAssignmentCandidate.of(
                "CAND-001",
                "MIS-001",
                "DRV-001",
                "TRACTOR-001",
                ...
                List.of(
                        ...
                        DispatchCheckResult.ready(DispatchCheckType.PARKING_READY, "Trattore e semirimorchio agganciati"),
        ...
        DispatchAssignmentCandidate blocked = DispatchAssignmentCandidate.of(
                "CAND-002",
                "MIS-001",
                "DRV-002",
                "TRUCK-002",
                ...
                Money.of("900.00", "EUR"),
                List.of(
                        DispatchCheckResult.blocked(DispatchCheckType.DRIVER_LICENSE, "Patente non compatibile"),
                        DispatchCheckResult.ready(DispatchCheckType.COST_MARGIN, "Margine positivo")
                ),
                Notes.empty()
        );

        DispatchPlan plan = DispatchPlan.of("PLAN-001", LocalDate.of(2026, 6, 29), List.of(ready, blocked), Notes.empty());

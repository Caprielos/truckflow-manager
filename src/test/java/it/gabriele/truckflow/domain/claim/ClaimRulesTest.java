...
class ClaimRulesTest {
  ...
  void shouldRequireUrgentReviewForHighSeverityClaims() {
    ...
    TransportClaim lowSeverityClaim =
        TransportClaim.open(
            "CLM-002",
            "SHP-001",
            "CUST-001",
  ...
  void shouldRequireUrgentReviewForTemperatureExcursionFromMediumSeverity() {
    TransportClaim temperatureClaim =
        TransportClaim.open(
            "CLM-003",
            "SHP-001",
            "CUST-001",
  ...
  void shouldCheckAcceptedCompensationWithinRequestedAmount() {
    TransportClaim accepted = openClaim().startReview().accept(Money.of("800.00", "EUR"));
  ...
  void shouldNotAllowNullClaim() {
    ...
    assertThrows(
        ...
        () -> ClaimRules.isAcceptedCompensationWithinRequestedAmount(null));
  }

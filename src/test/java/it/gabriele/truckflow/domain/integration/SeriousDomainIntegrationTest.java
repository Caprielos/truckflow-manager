...
class SeriousDomainIntegrationTest {
  ...
  void shouldCreateTechnicalVehicleAndCombinationSummary() {
    ...
    VehicleCombination combination =
        VehicleCombination.withTrailer("combo-001", truck, trailer, Notes.empty());
  ...
  void shouldUseDriverCertificatesWithRealExpiryDates() {
    Driver driver =
        Driver.availableWithCertificates(
            "drv-001",
            "Mario Rossi",
            ...
            Notes.empty(),
            List.of(
                DriverCertificate.of(
                    DriverCertificateType.CQC_GOODS,
                    LocalDate.of(2024, 1, 1),
                    LocalDate.of(2029, 1, 1),
                    "CQC-1",
                    Notes.empty()),
                DriverCertificate.of(
                    DriverCertificateType.ADR_BASIC,
                    LocalDate.of(2024, 1, 1),
                    LocalDate.of(2029, 1, 1),
                    "ADR-1",
                    Notes.empty()),
                DriverCertificate.of(
                    DriverCertificateType.INTERNATIONAL_TRANSPORT,
                    LocalDate.of(2024, 1, 1),
    ...
    assertTrue(
        driver.hasValidCertificate(DriverCertificateType.CQC_GOODS, LocalDate.of(2026, 1, 1)));
    assertFalse(
        driver.hasValidCertificate(DriverCertificateType.CQC_GOODS, LocalDate.of(2030, 1, 1)));
    ...
    TransportCompany company =
        TransportCompany.of(
            ...
            List.of(
                ...
                CompanyLicense.of(
                    CompanyLicenseType.COMMUNITY_LICENSE, LocalDate.of(2030, 1, 1), Notes.empty()),
                CompanyLicense.of(
                    CompanyLicenseType.ENVIRONMENTAL_MANAGERS_REGISTER_CATEGORY_4,
                    LocalDate.of(2028, 1, 1),
                    Notes.empty())),
            Notes.empty());

    assertTrue(
        CompanyComplianceRules.canOperateInternationalTransport(company, LocalDate.of(2026, 1, 1)));
    assertTrue(
        CompanyComplianceRules.canTransportCargo(
            company, CargoCategory.WASTE_NON_DANGEROUS, false, LocalDate.of(2026, 1, 1)));
    assertTrue(
        CompanyComplianceRules.canTransportCargo(
            company, CargoCategory.PALLETIZED_DRY_GOODS, true, LocalDate.of(2026, 1, 1)));
  }
  ...
  void shouldEvaluateLoadSecurityFuelTireAndTelematicsRules() {
    ...
    assertTrue(
        LoadSecuringRules.hasMinimumEquipmentForCargo(
            checklist, CargoCategory.PALLETIZED_DRY_GOODS, Weight.ofKilograms(12000)));
    ...
    TireInstallation installation =
        TireInstallation.active(
            tire,
            "trailer-001",
            WheelPosition.of(2, WheelSide.RIGHT, WheelSlot.OUTER),
  ...
  private static VehicleTechnicalSpecification rigidTruckTechnicalSpecification() {
    return VehicleTechnicalSpecification.of(
        VehicleMassSpecification.of(
            Weight.ofKilograms(26000), Weight.ofKilograms(11000), Weight.ofKilograms(18000), null),
        VehicleDimensionSpecification.of(
            Dimension.ofMeters(8.0, 2.55, 3.7), Dimension.ofMeters(7.2, 2.48, 2.4), 1.1, 18),
        ...
        List.of(
            VehicleCertificate.of(
                VehicleCertificateType.ROADWORTHINESS_INSPECTION,
                LocalDate.of(2026, 1, 1),
  ...
  private static VehicleTechnicalSpecification drawbarTrailerTechnicalSpecification() {
    return VehicleTechnicalSpecification.of(
        VehicleMassSpecification.of(
            Weight.ofKilograms(18000), Weight.ofKilograms(5000), null, null),
        VehicleDimensionSpecification.of(
            Dimension.ofMeters(7.8, 2.55, 3.7), Dimension.ofMeters(7.2, 2.48, 2.4), 1.1, 18),
        VehicleAxleSpecification.of(
            List.of(
                VehicleAxle.of(1, WheelConfiguration.SINGLE, false, AxleSteeringType.FIXED),
                VehicleAxle.of(
                    2, WheelConfiguration.SINGLE, false, AxleSteeringType.SELF_STEERING)),
            SuspensionType.PNEUMATIC,
            BrakeType.DISC,
            Set.of(BrakeSafetySystem.ABS, BrakeSafetySystem.EBS),
            "SAF"),

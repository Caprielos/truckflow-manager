...
class SupplierInvoiceTest {
    ...
    void shouldSeparateCapitalAssetsFromOperatingExpenses() {
        SupplierInvoice invoice = SupplierInvoice.received(
                ...
                List.of(
                        PurchaseLine.of("L1", PurchaseCategory.VEHICLE_PURCHASE,
                                "Trattore stradale", Money.of("120000", "EUR"), Notes.empty()),
                        PurchaseLine.of("L2", PurchaseCategory.INSURANCE_PREMIUM,
                                "Prima rata assicurazione", Money.of("3500", "EUR"), Notes.empty())
                ),
                Notes.empty()
        );
    ...
    void shouldRejectDuplicatedPurchaseLineCodes() {
        PurchaseLine first = PurchaseLine.of("L1", PurchaseCategory.FUEL,
                "Gasolio", Money.of("500", "EUR"), Notes.empty());
        PurchaseLine duplicated = PurchaseLine.of("L1", PurchaseCategory.TOLL,
                "Pedaggi", Money.of("120", "EUR"), Notes.empty());

        assertThrows(IllegalArgumentException.class, () -> SupplierInvoice.received(
                "SUP-2026-002",
                "SUPPLIER-001",
                LocalDate.of(2026, 2, 1),
                LocalDate.of(2026, 3, 1),

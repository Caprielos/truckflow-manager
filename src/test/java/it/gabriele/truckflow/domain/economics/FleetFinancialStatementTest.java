  ...
  void shouldShowCashDebtWhenCompanyBuysVehicleAndRevenueIsNotEnoughYet() {
        ...
        MissionEconomics.of(
            ...
            List.of(
                MissionRevenueLine.baseTransportFee(
                    "REV-BASE", "Trasporto cliente", Money.of("1500", "EUR"), Notes.empty())),
            List.of(
                MissionCostLine.of(
                    "COST-FUEL",
    ...
    SupplierInvoice maintenanceInvoice =
        SupplierInvoice.received(
            ...
            PurchaseLine.of(
                "L1",
                PurchaseCategory.MAINTENANCE_LABOR,
                "Tagliando e controllo freni",
                Money.of("600", "EUR"),
                Notes.empty()));
    ...
    FleetFinancialStatement statement =
        FleetFinancialStatement.of(
            "FIN-2026-04",

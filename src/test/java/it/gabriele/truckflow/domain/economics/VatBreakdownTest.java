...
class VatBreakdownTest {
    ...
    void shouldCalculateItalianVatFromNetAmountAndKeepVatSeparateFromCost() {
        VatBreakdown vat = VatBreakdown.taxableFromNet(Money.of("100000", "EUR"), VatRate.italianStandard22());
    ...
    void shouldTreatNonDeductibleVatAsRealCost() {
        VatBreakdown vat = VatBreakdown.nonDeductibleFromNet(Money.of("1000", "EUR"), VatRate.italianStandard22());

...
class FacilityTest {
  ...
  void shouldNotAllowNullMandatoryFields() {
    ...
    assertThrows(
        ...
        () ->
            Facility.active(
                "MIL-WAREHOUSE-01", FacilityType.WAREHOUSE, milanLocation(), null, Notes.empty()));
  ...
  void shouldFormatSingleLine() {
    ...
    assertEquals(
        "MIL-WAREHOUSE-01 - WAREHOUSE - Magazzino Milano - Via Roma 10, 20100 Milano, IT"
            + " [Europe/Rome]",
  ...
  private static Location milanLocation() {
    return Location.of(
        ...
        Address.withCoordinates(
            "Via Roma 10", "Milano", "20100", "IT", GeoCoordinates.of(45.4642, 9.1900)),
        "Europe/Rome");
  }
}

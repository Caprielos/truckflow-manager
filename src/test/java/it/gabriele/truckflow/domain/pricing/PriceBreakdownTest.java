...
class PriceBreakdownTest {
    ...
    void shouldNotAllowDuplicatedLineCodes() {
        assertThrows(IllegalArgumentException.class, () -> PriceBreakdown.of(
                "QUOTE-001",
                List.of(baseFreightLine(), baseFreightLine()),
                Notes.empty()
        ));
    }
    ...
    void shouldExposeUnmodifiableLines() {
        ...
        assertThrows(UnsupportedOperationException.class, () -> breakdown.getLines().add(baseFreightLine()));
    }
    ...
    void shouldDetectNotes() {
        PriceBreakdown breakdown = PriceBreakdown.of(
                "QUOTE-001",
                List.of(baseFreightLine()),
                Notes.of("Preventivo valido 15 giorni")
        );
    ...
    void shouldFormatSingleLine() {
        assertEquals(
                "QUOTE-001 - lines: 6 - total: 1350.00 EUR",
                standardBreakdown().formatSingleLine()
        );
    }

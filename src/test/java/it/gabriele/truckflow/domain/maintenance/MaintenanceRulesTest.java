...
class MaintenanceRulesTest {
  ...
  void shouldCheckVehicleAvailabilityBlocking() {
    ...
    MaintenanceWorkOrder openRepair =
        MaintenanceWorkOrder.open(
            "MNT-002", standardVehicle(), MaintenanceType.REPAIR, Notes.empty());
  ...
  void shouldNotAllowNullWorkOrder() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> MaintenanceRules.blocksVehicleAvailability(null));
    assertThrows(
        IllegalArgumentException.class, () -> MaintenanceRules.shouldMakeVehicleUnavailable(null));
    assertThrows(
        IllegalArgumentException.class, () -> MaintenanceRules.requiresAdrSpecialist(null));

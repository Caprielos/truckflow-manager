...
class InventoryManagementTest {
    ...
    void shouldCalculateWarehouseStockAndReorderSignal() {
        ...
        InventoryStockMovement in = InventoryStockMovement.of(
                "MOV-001",
                "PAD-001",
                location,
        ...
        InventoryStockMovement used = InventoryStockMovement.of(
                "MOV-002",
                "PAD-001",
                location,
        ...
        InventoryBalance balance = InventoryBalance.fromMovements(brakePads, location, List.of(in, used));

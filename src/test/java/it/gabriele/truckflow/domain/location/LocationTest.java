...
class LocationTest {
  ...
  void shouldCreateLocationUsingZoneId() {
    ...
    Location location = Location.of("Magazzino Milano", address, ZoneId.of("Europe/Rome"));
  ...
  void shouldNotAllowNullOrBlankName() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> Location.of(null, address, ZoneId.of("Europe/Rome")));
  ...
  void shouldNotAllowNullOrBlankZoneIdString() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> Location.of("Magazzino Milano", address, "   "));
  }
  ...
  void shouldNotCheckSameTimeZoneWithNullLocation() {
    ...
    assertThrows(IllegalArgumentException.class, () -> location.isInSameTimeZone(null));
  }

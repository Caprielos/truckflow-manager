...
class GeoCoordinatesTest {
    ...
    void shouldNotAllowInvalidNumbers() {
        ...
        assertThrows(IllegalArgumentException.class, () -> GeoCoordinates.of(Double.POSITIVE_INFINITY, 9));
        assertThrows(IllegalArgumentException.class, () -> GeoCoordinates.of(45, Double.POSITIVE_INFINITY));
    }

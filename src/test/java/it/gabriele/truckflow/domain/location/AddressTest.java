...
class AddressTest {
  ...
  void shouldCreateAddressWithCoordinates() {
    ...
    Address address = Address.withCoordinates("Via Roma 10", "Milano", "20100", "IT", coordinates);
  ...
  void shouldNotAllowNullOrBlankRequiredFields() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> Address.of("Via Roma 10", null, "20100", "IT"));
    assertThrows(
        IllegalArgumentException.class, () -> Address.of("Via Roma 10", "Milano", null, "IT"));
    assertThrows(
        IllegalArgumentException.class, () -> Address.of("Via Roma 10", "Milano", "20100", null));

    assertThrows(IllegalArgumentException.class, () -> Address.of("   ", "Milano", "20100", "IT"));
    assertThrows(
        IllegalArgumentException.class, () -> Address.of("Via Roma 10", "   ", "20100", "IT"));
    assertThrows(
        IllegalArgumentException.class, () -> Address.of("Via Roma 10", "Milano", "   ", "IT"));
    assertThrows(
        IllegalArgumentException.class, () -> Address.of("Via Roma 10", "Milano", "20100", "   "));
  }
  ...
  void shouldNotAllowTooLongFields() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> Address.of(tooLongText, "Milano", "20100", "IT"));
    assertThrows(
        IllegalArgumentException.class,
        () -> Address.of("Via Roma 10", tooLongText, "20100", "IT"));
    assertThrows(
        IllegalArgumentException.class,
        () -> Address.of("Via Roma 10", "Milano", tooLongText, "IT"));
  }

  @Test
  void shouldNotAllowInvalidCountryCode() {
    assertThrows(
        IllegalArgumentException.class, () -> Address.of("Via Roma 10", "Milano", "20100", "ITA"));
    assertThrows(
        IllegalArgumentException.class, () -> Address.of("Via Roma 10", "Milano", "20100", "I"));
    assertThrows(
        IllegalArgumentException.class, () -> Address.of("Via Roma 10", "Milano", "20100", "1T"));
  }
  ...
  void shouldNotCreateAddressWithNullCoordinatesUsingWithCoordinatesFactory() {
    assertThrows(
        IllegalArgumentException.class,
        () -> Address.withCoordinates("Via Roma 10", "Milano", "20100", "IT", null));
  }

...
class RouteStopTest {
    ...
    void shouldNotAllowInvalidSequenceNumber() {
        assertThrows(IllegalArgumentException.class, () -> RouteStop.of(
                0,
                RouteStopType.PICKUP,
                milanFacility(),
    ...
    void shouldDetectStopTypes() {
        RouteStop start = RouteStop.of(1, RouteStopType.START, milanFacility(), TimeWindow.of("08:00", "09:00"), Notes.empty());
        RouteStop pickup = RouteStop.of(2, RouteStopType.PICKUP, milanFacility(), TimeWindow.of("09:00", "10:00"), Notes.empty());
        RouteStop delivery = RouteStop.of(3, RouteStopType.DELIVERY, romeFacility(), TimeWindow.of("14:00", "15:00"), Notes.empty());
        RouteStop end = RouteStop.of(4, RouteStopType.END, romeFacility(), TimeWindow.of("15:00", "16:00"), Notes.empty());
    ...
    void shouldDetectCargoOperation() {
        RouteStop pickup = RouteStop.of(1, RouteStopType.PICKUP, milanFacility(), TimeWindow.of("08:00", "12:00"), Notes.empty());
        RouteStop delivery = RouteStop.of(2, RouteStopType.DELIVERY, romeFacility(), TimeWindow.of("14:00", "18:00"), Notes.empty());
        RouteStop fuelStop = RouteStop.of(3, RouteStopType.FUEL_STOP, romeFacility(), TimeWindow.of("18:00", "19:00"), Notes.empty());
    ...
    void shouldCheckIfStopsAreAtSameFacility() {
        ...
        RouteStop first = RouteStop.of(1, RouteStopType.START, facility, TimeWindow.of("08:00", "09:00"), Notes.empty());
        RouteStop second = RouteStop.of(2, RouteStopType.PICKUP, facility, TimeWindow.of("09:00", "10:00"), Notes.empty());
        RouteStop third = RouteStop.of(3, RouteStopType.DELIVERY, romeFacility(), TimeWindow.of("14:00", "15:00"), Notes.empty());
    ...
    void shouldNotCompareSameFacilityWithNullStop() {
        RouteStop stop = RouteStop.of(1, RouteStopType.PICKUP, milanFacility(), TimeWindow.of("08:00", "12:00"), Notes.empty());
    ...
    void shouldCheckIfStopIsBeforeAnotherStop() {
        RouteStop first = RouteStop.of(1, RouteStopType.PICKUP, milanFacility(), TimeWindow.of("08:00", "12:00"), Notes.empty());
        RouteStop second = RouteStop.of(2, RouteStopType.DELIVERY, romeFacility(), TimeWindow.of("14:00", "18:00"), Notes.empty());

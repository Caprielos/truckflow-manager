...
class RoutePlanRulesTest {
    ...
    void shouldDetectRouteWithoutCargoOperations() {
        RoutePlan routePlan = RoutePlan.of(
                ...
                List.of(
                        ...
                        RouteStop.of(2, RouteStopType.END, romeFacility(), TimeWindow.of("16:00", "17:00"), Notes.empty())
                ),
    ...
    void shouldDetectMissingDelivery() {
        RoutePlan routePlan = RoutePlan.of(
                ...
                List.of(
                        RouteStop.of(1, RouteStopType.START, milanFacility(), TimeWindow.of("08:00", "09:00"), Notes.empty()),
                        RouteStop.of(2, RouteStopType.PICKUP, milanFacility(), TimeWindow.of("09:00", "10:00"), Notes.empty()),
                        RouteStop.of(3, RouteStopType.END, romeFacility(), TimeWindow.of("16:00", "17:00"), Notes.empty())
                ),
                Distance.ofKilometers(580),
                Notes.empty()
        );
    ...
    void shouldDetectSameStartAndEndFacility() {
        RoutePlan routePlan = RoutePlan.of(
                ...
                List.of(
                        RouteStop.of(1, RouteStopType.START, milanFacility(), TimeWindow.of("08:00", "09:00"), Notes.empty()),
                        RouteStop.of(2, RouteStopType.PICKUP, milanFacility(), TimeWindow.of("09:00", "10:00"), Notes.empty()),
                        RouteStop.of(3, RouteStopType.DELIVERY, milanFacility(), TimeWindow.of("14:00", "15:00"), Notes.empty()),
                        RouteStop.of(4, RouteStopType.END, milanFacility(), TimeWindow.of("16:00", "17:00"), Notes.empty())
                ),
    ...
    void shouldDetectInactiveFacility() {
        RoutePlan routePlan = RoutePlan.of(
                ...
                List.of(
                        RouteStop.of(1, RouteStopType.START, milanFacility(), TimeWindow.of("08:00", "09:00"), Notes.empty()),
                        RouteStop.of(2, RouteStopType.PICKUP, inactiveMilanFacility(), TimeWindow.of("09:00", "10:00"), Notes.empty()),
                        RouteStop.of(3, RouteStopType.DELIVERY, romeFacility(), TimeWindow.of("14:00", "15:00"), Notes.empty()),
                        RouteStop.of(4, RouteStopType.END, romeFacility(), TimeWindow.of("16:00", "17:00"), Notes.empty())
                ),
                Distance.ofKilometers(580),
                Notes.empty()
        );
    ...
    void shouldNotAllowNullRoutePlan() {
        ...
        assertThrows(IllegalArgumentException.class, () -> RoutePlanRules.isWithinMaxDistance(null, Distance.ofKilometers(100)));
        assertThrows(IllegalArgumentException.class, () -> RoutePlanRules.startsAndEndsAtDifferentFacilities(null));
        assertThrows(IllegalArgumentException.class, () -> RoutePlanRules.usesOnlyActiveFacilities(null));
    ...
    void shouldNotAllowNullMaxDistance() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> RoutePlanRules.isWithinMaxDistance(routePlan, null));
    }

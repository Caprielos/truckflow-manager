...
class ShipmentRulesTest {
    ...
    void shouldCheckInTransitRule() {
        Shipment dispatchedShipment = createdStandardShipment()
                .plan()
                .dispatch();
    ...
    void shouldCheckDeliveryRule() {
        Shipment inTransitShipment = createdStandardShipment()
                .plan()
                .dispatch()
                .markInTransit();
    ...
    void shouldCheckCancellationRule() {
        Shipment createdShipment = createdStandardShipment();
        Shipment deliveredShipment = createdStandardShipment()
                .plan()
                .dispatch()
                .markInTransit()
                .deliver();

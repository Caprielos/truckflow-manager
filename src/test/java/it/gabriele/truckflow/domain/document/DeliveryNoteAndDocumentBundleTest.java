...
class DeliveryNoteAndDocumentBundleTest {
    ...
    void shouldModelStructuredDeliveryNoteAndDocumentBundle() {
        DeliveryNote deliveryNote = DeliveryNote.of(
                "DDT-001",
                "SHP-001",
                "ACME-MI",
                "CLIENTE-RM",
                ...
                List.of(
                        ...
                        DeliveryNoteLine.of("L2", "Collo controllo temperatura", 1, 20, 0.2, 0, Notes.empty())
                ),
                TemperatureRange.ofCelsius(2, 8),
                Notes.empty()
        );

        TransportDocument cmr = TransportDocument.verified(
                "CMR-001",

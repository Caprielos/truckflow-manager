...
class DocumentRulesTest {
  ...
  void shouldCheckValidDocumentsList() {
    List<TransportDocument> documents = List.of(verifiedCmr(), verifiedPod());

    assertTrue(DocumentRules.allDocumentsValidForOperation(documents, LocalDate.of(2026, 7, 10)));
  ...
  void shouldReturnFalseWhenDocumentListIsEmpty() {
    assertFalse(DocumentRules.allDocumentsValidForOperation(List.of(), LocalDate.of(2026, 7, 10)));
  }
  ...
  void shouldNotAllowNullValues() {
    ...
    assertThrows(
        ...
        () -> DocumentRules.isExpiredOn(null, LocalDate.of(2026, 7, 10)));
    assertThrows(IllegalArgumentException.class, () -> DocumentRules.isExpiredOn(document, null));
    assertThrows(
        IllegalArgumentException.class,
        () -> DocumentRules.isValidForOperation(null, LocalDate.of(2026, 7, 10)));
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> DocumentRules.allDocumentsValidForOperation(null, LocalDate.of(2026, 7, 10)));
  }
  ...
  void shouldNotAllowNullDocumentsInsideList() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> DocumentRules.containsAdrDocument(documentsWithNull));
    assertThrows(
        IllegalArgumentException.class,
        () ->
            DocumentRules.allDocumentsValidForOperation(
                documentsWithNull, LocalDate.of(2026, 7, 10)));
  }

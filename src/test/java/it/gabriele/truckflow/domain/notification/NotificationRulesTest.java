...
class NotificationRulesTest {
    ...
    void shouldDetectImmediateAttention() {
        ...
        NotificationMessage normalMessage = NotificationMessage.draft(
                "NTF-002",
        ...
        NotificationMessage securityMessage = NotificationMessage.draft(
                "NTF-003",
    ...
    void shouldCheckCustomerNotification() {
        ...
        NotificationMessage internalMessage = NotificationMessage.draft(
                "NTF-002",
    ...
    void shouldCheckNotificationCategories() {
        ...
        NotificationMessage financial = NotificationMessage.draft(
                "NTF-002",
        ...
        NotificationMessage security = NotificationMessage.draft(
                "NTF-003",
                NotificationType.SECURITY_ALERT,
                NotificationChannel.IN_APP,
                NotificationRecipientType.ADMIN,
    ...
    void shouldNotAllowNullMessage() {
        ...
        assertThrows(IllegalArgumentException.class, () -> NotificationRules.requiresImmediateAttention(null));
        assertThrows(IllegalArgumentException.class, () -> NotificationRules.shouldNotifyCustomer(null));
        assertThrows(IllegalArgumentException.class, () -> NotificationRules.isOperationalNotification(null));
        assertThrows(IllegalArgumentException.class, () -> NotificationRules.isFinancialNotification(null));
        assertThrows(IllegalArgumentException.class, () -> NotificationRules.isSecurityNotification(null));

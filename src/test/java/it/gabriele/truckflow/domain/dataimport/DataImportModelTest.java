...
class DataImportModelTest {
    ...
    void shouldModelExternalCostImportBatch() {
        ImportRecord fuel = ImportRecord.of(
                "REC-001",
        ...
        ImportRecord toll = ImportRecord.of(
                "REC-002",
                ExternalDataSourceType.FUEL_CARD,
                "DKV/124",
                ImportRecordStatus.VALIDATED,
        ...
        ImportBatch batch = ImportBatch.of(
                "BATCH-001",
                ExternalDataSourceType.FUEL_CARD,
        ...
        assertEquals(Money.of("362.70", "EUR"), batch.calculateAmountTotal(Currency.getInstance("EUR")));
    }
}

...
class ResourceAvailabilityTest {
    ...
    void shouldCreateBlockingStatuses() {
        assertTrue(ResourceAvailability.reserved(
        ...
        assertTrue(ResourceAvailability.assigned(
        ...
        assertTrue(ResourceAvailability.maintenance(
        ...
        assertTrue(ResourceAvailability.onLeave(
                AvailabilityResourceType.DRIVER,
                "DRV-001",
                dateRange(),
                timeWindow(),
    ...
    void shouldNotAllowInvalidResourceCode() {
        assertThrows(IllegalArgumentException.class, () -> ResourceAvailability.available(
                AvailabilityResourceType.DRIVER,
                null,
                dateRange(),
                timeWindow(),
    ...
    void shouldNotAllowNullMandatoryFields() {
        assertThrows(IllegalArgumentException.class, () -> ResourceAvailability.of(
                null,
                "DRV-001",
                dateRange(),
                timeWindow(),
    ...
    void shouldCheckSameResource() {
        ...
        ResourceAvailability second = ResourceAvailability.assigned(
                AvailabilityResourceType.DRIVER,
                "DRV-001",
                dateRange(),
                timeWindow(),
        ...
        ResourceAvailability differentResource = ResourceAvailability.available(
                AvailabilityResourceType.DRIVER,
                "DRV-002",
                dateRange(),
                timeWindow(),
    ...
    void shouldCheckOverlaps() {
        ...
        ResourceAvailability overlapping = ResourceAvailability.reserved(
                AvailabilityResourceType.DRIVER,
                "DRV-001",
                dateRange(),
        ...
        ResourceAvailability differentResource = ResourceAvailability.reserved(
                AvailabilityResourceType.DRIVER,
                "DRV-002",
                dateRange(),
                TimeWindow.of("12:00", "16:00"),
    ...
    void shouldDetectNotes() {
        ResourceAvailability availability = ResourceAvailability.unavailable(
                AvailabilityResourceType.DRIVER,
                "DRV-001",
                dateRange(),
                timeWindow(),
    ...
    void shouldFormatSingleLine() {
        assertEquals(
                "DRIVER - DRV-001 - AVAILABLE",
                driverAvailable().formatSingleLine()
        );
    }

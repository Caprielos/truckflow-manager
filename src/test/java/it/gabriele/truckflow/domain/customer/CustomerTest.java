...
class CustomerTest {
    ...
    void shouldCreateInactiveCustomer() {
        Customer customer = Customer.inactive(
                "CUST-001",
                "ACME Logistics S.r.l.",
                CustomerType.COMPANY,
                customerLocation(),
    ...
    void shouldCreateSuspendedCustomer() {
        Customer customer = Customer.suspended(
                "CUST-001",
                "ACME Logistics S.r.l.",
                CustomerType.COMPANY,
                customerLocation(),
    ...
    void shouldNotAllowInvalidCode() {
        assertThrows(IllegalArgumentException.class, () -> Customer.active(
                null,
                "ACME Logistics S.r.l.",
                CustomerType.COMPANY,
                customerLocation(),
    ...
    void shouldDetectBusinessCustomer() {
        Customer company = Customer.active(
                "CUST-001",
                "ACME Logistics S.r.l.",
                CustomerType.COMPANY,
                customerLocation(),
        ...
        Customer individual = Customer.active(
                "CUST-002",
                "Mario Rossi",
    ...
    void shouldFormatSingleLine() {
        ...
        assertEquals(
                "CUST-001 - ACME Logistics S.r.l. - COMPANY - ACTIVE",
                customer.formatSingleLine()
        );
    }

    @Test
    void shouldConsiderEquivalentCustomersEqual() {
        Customer first = Customer.active(
                "  cust-001  ",
                "  ACME Logistics S.r.l.  ",
                CustomerType.COMPANY,
                customerLocation(),
        ...
        Customer second = Customer.active(
                "CUST-001",
                "ACME Logistics S.r.l.",
                CustomerType.COMPANY,
                customerLocation(),

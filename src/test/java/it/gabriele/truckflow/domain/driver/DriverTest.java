...
class DriverTest {
  ...
  void shouldNotAllowNullLicenseInsideSet() {
    Set<DriverLicenseCategory> licenses =
        new HashSet<>(Arrays.asList(DriverLicenseCategory.C, null));
  ...
  void shouldNotAllowNullValuesInsideOptionalSets() {
    Set<DriverProfessionalQualification> professionalQualifications =
        new HashSet<>(Arrays.asList(DriverProfessionalQualification.CQC_GOODS, null));

    Set<DriverAdrCertificateType> adrCertificates =
        new HashSet<>(Arrays.asList(DriverAdrCertificateType.ADR_BASIC, null));

    Set<DriverOperationalQualification> operationalQualifications =
        new HashSet<>(Arrays.asList(DriverOperationalQualification.INTERNATIONAL_TRANSPORT, null));
    ...
    assertThrows(
        ...
        () ->
            driver
                ...
                .add(DriverOperationalQualification.HIGH_VALUE_CARGO));
  }
  ...
  void shouldCheckAllRequiredLicenseCategories() {
    ...
    assertTrue(
        driver.hasAllLicenseCategories(Set.of(DriverLicenseCategory.C, DriverLicenseCategory.E)));

    assertFalse(
        driver.hasAllLicenseCategories(Set.of(DriverLicenseCategory.B, DriverLicenseCategory.C)));
  }
  ...
  void shouldNotCheckInvalidLicenseCategories() {
    ...
    Set<DriverLicenseCategory> licensesWithNull =
        new HashSet<>(Arrays.asList(DriverLicenseCategory.C, null));

    assertThrows(
        IllegalArgumentException.class, () -> driver.hasAllLicenseCategories(licensesWithNull));
  }
  ...
  void shouldNotCheckNullProfessionalQualification() {
    ...
    assertThrows(IllegalArgumentException.class, () -> driver.hasProfessionalQualification(null));
  }
  ...
  void shouldNotCheckNullAdrCertificate() {
    ...
    assertThrows(IllegalArgumentException.class, () -> driver.hasAdrCertificate(null));
  }
  ...
  void shouldCheckOperationalQualifications() {
    ...
    assertTrue(
        driver.hasOperationalQualification(
            DriverOperationalQualification.TEMPERATURE_CONTROLLED_TRANSPORT));
    assertFalse(
        driver.hasOperationalQualification(DriverOperationalQualification.HIGH_VALUE_CARGO));
  }
  ...
  void shouldNotCheckNullOperationalQualification() {
    ...
    assertThrows(IllegalArgumentException.class, () -> driver.hasOperationalQualification(null));
  }
  ...
  private static Set<DriverLicenseCategory> standardLicenses() {
    return Set.of(DriverLicenseCategory.C, DriverLicenseCategory.E);
  }

  private static Set<DriverProfessionalQualification> standardProfessionalQualifications() {
    return Set.of(DriverProfessionalQualification.CQC_GOODS);
  }

  private static Set<DriverAdrCertificateType> standardAdrCertificates() {
    return Set.of(DriverAdrCertificateType.ADR_BASIC, DriverAdrCertificateType.ADR_TANK);
  }

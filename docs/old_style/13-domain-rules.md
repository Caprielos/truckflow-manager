...
3. aggiornare `docs/old_style/13-domain-rules.md` quando cambiano regole architetturali;
4. aggiornare `docs/old_style/14-domain-review-patches.md` quando vengono eseguiti nuovi interventi correttivi rilevanti;
5. aggiornare `docs/old_style/15-domain-test-suite-review.md` quando cambiano copertura, confini o strategia dei test del dominio puro;

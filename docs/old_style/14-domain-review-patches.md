...
Dopo la review correttiva del dominio puro e la revisione finale della test suite, il progetto introduce `docs/old_style/16-application-layer-blueprint.md`.
...
- documentazione dedicata in `docs/old_style/18-application-repository-ports.md`.

...
La documentazione digitale in `docs/digital/index.html` è il mirror navigabile della documentazione Markdown.
...
Le REST API dovrebbero restare un punto successivo, perché devono esporre use case stabili e non accedere direttamente al dominio. Il documento ufficiale di apertura è [`docs/old_style/30-infrastructure-layer-blueprint.md`](30-infrastructure-layer-blueprint.md).
